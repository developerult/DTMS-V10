<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadBoardPROD.aspx.cs" Inherits="DynamicsTMS365.LoadBoard" %>
        ...
        function LoadBoardGridDataBoundCallBack(e,tGrid){           
            ...
            if (typeof (iBookPK) !== 'undefined' && iBookPK !== null && iBookPK !== 0) {
                ...
                $(rows).each(function(e) {
                    ...
                    if (dataItem.BookControl == iBookPK) { oLoadBoardGrid.select(row); }
                });
            }
        }
