...
//    if ($('.k-icon k-i-gear')[0]) {
//        kendo.ui.icon($('span[class^="k-icon k-i-gear"]'), { icon: 'gear' });
//    }
//    if ($('.k-icon k-i-chevron-up')[0]) {
//        kendo.ui.icon($('span[class^="k-icon k-i-chevron-up"]'), { icon: 'gear' });
//    }
//    if ($('.k-icon k-i-chevron-down')[0]) {
//        kendo.ui.icon($('span[class^="k-icon k-i-chevron-down"]'), { icon: 'gear' });
//    }
//}
var ngl = {
    kmask: null,
    ...
    AlertDialog: null,
    //new fix kendo ui icon svg logic

    RunKendoIconFix: function () {
        if($('span[class^="k-icon k-i-pencil"]') && $('span[class^="k-icon k-i-pencil"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-pencil"]'), { icon: 'pencil' }); }
        if ($('span[class^="k-icon k-i-edit"]') && $('span[class^="k-icon k-i-edit"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-edit"]'), { icon: 'pencil' }); }
        if ($('span[class^="k-icon k-i-trash"]') && $('span[class^="k-icon k-i-trash"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-trash"]'), { icon: 'trash' }); }
        if ($('span[class^="k-icon k-i-delete"]') && $('span[class^="k-icon k-i-delete"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-delete"]'), { icon: 'trash' }); }
        if ($('span[class^="k-icon k-i-check"]') && $('span[class^="k-icon k-i-check"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-check"]'), { icon: 'check' }); }
        if ($('span[class^="k-icon k-i-cancel"]') && $('span[class^="k-icon k-i-cancel"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-cancel"]'), { icon: 'cancel' }); }
        if ($('span[class^="k-icon k-i-gear"]') && $('span[class^="k-icon k-i-gear"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-gear"]'), { icon: 'gear' }); }
        if ($('span[class^="k-icon k-i-chevron-up"]') && $('span[class^="k-icon k-i-chevron-up"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-chevron-up"]'), { icon: 'chevron-up' }); }
        if ($('span[class^="k-icon k-i-chevron-down"]') && $('span[class^="k-icon k-i-chevron-down"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-chevron-down"]'), { icon: 'chevron-down' }); }
        if ($('span[class^="k-icon k-i-arrow-chevron-up"]') && $('span[class^="k-icon k-i-arrow-chevron-up"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-arrow-chevron-up"]'), { icon: 'chevron-up' }); }
        if ($('span[class^="k-icon k-i-arrow-chevron-down"]') && $('span[class^="k-icon k-i-arrow-chevron-down"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-arrow-chevron-down"]'), { icon: 'chevron-down' }); }
        if ($('span[class^="k-icon k-i-plus"]') && $('span[class^="k-icon k-i-plus"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-plus"]'), { icon: 'plus' }); }
        if ($('span[class^="k-icon k-i-add"]') && $('span[class^="k-icon k-i-add"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-add"]'), { icon: 'plus' }); }
        if ($('span[class^="k-icon k-i-sort-asc-small"]') && $('span[class^="k-icon k-i-sort-asc-small"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-sort-asc-small"]'), { icon: 'sort-asc-small' }); }
        if ($('span[class^="k-icon k-i-k-i-sort-asc-sm "]') && $('span[class^="k-icon k-i-k-i-sort-asc-sm "]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-k-i-sort-asc-sm "]'), { icon: 'sort-asc-small' }); }
        if ($('span[class^="k-icon k-i-save"]') && $('span[class^="k-icon k-i-save"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-save"]'), { icon: 'save' }); }
        if ($('span[class^="k-icon k-i-info-circle"]') && $('span[class^="k-icon k-i-info-circle"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-info-circle"]'), { icon: 'info-circle' }); }
        if ($('span[class^="k-icon k-i-information"]') && $('span[class^="k-icon k-i-information"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-information"]'), { icon: 'info-circle' }); }
        if ($('span[class^="k-icon k-i-user"]') && $('span[class^="k-icon k-i-user"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-user"]'), { icon: 'user' }); }
        if ($('span[class^="k-icon k-i-x-outline"]') && $('span[class^="k-icon k-i-x-outline"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-x-outline"]'), { icon: 'x-outline' }); }
        if ($('span[class^="k-icon k-i-close-outline"]') && $('span[class^="k-icon k-i-close-outline"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-close-outline"]'), { icon: 'x-outline' }); }
        if ($('span[class^="k-icon k-i-heck-outline"]') && $('span[class^="k-icon k-i-heck-outline"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-heck-outline"]'), { icon: 'heck-outline' }); }
        if ($('span[class^="k-icon k-i-exclamation-circle"]') && $('span[class^="k-icon k-i-exclamation-circle"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-exclamation-circle"]'), { icon: 'exclamation-circle' }); }
        if ($('span[class^="k-icon k-i-warning"]') && $('span[class^="k-icon k-i-warning"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-warning"]'), { icon: 'exclamation-circle' }); }
        if ($('span[class^="k-icon k-i-bell"]') && $('span[class^="k-icon k-i-bell"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-bell"]'), { icon: 'bell' }); }
        if ($('span[class^="k-icon k-i-apply-format"]') && $('span[class^="k-icon k-i-apply-format"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-apply-format"]'), { icon: 'apply-format' }); }
        if ($('span[class^="k-icon k-i-star"]') && $('span[class^="k-icon k-i-star"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-star"]'), { icon: 'star' }); }
        if ($('span[class^="k-icon k-i-bookmark"]') && $('span[class^="k-icon k-i-bookmark"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-bookmark"]'), { icon: 'star' }); }
        if ($('span[class^="k-icon k-i-window"]') && $('span[class^="k-icon k-i-window"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-window"]'), { icon: 'window' }); }
        if ($('span[class^="k-icon k-i-track-changes-enable"]') && $('span[class^="k-icon k-i-track-changes-enable"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-track-changes-enable"]'), { icon: 'track-changes-enable' }); }
        if ($('span[class^="k-icon k-i-x"]') && $('span[class^="k-icon k-i--x"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-x"]'), { icon: 'x' }); }
        if ($('span[class^="k-icon k-i-close"]') && $('span[class^="k-icon k-i-close"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-close"]'), { icon: 'x' }); }
        if ($('span[class^="k-icon k-i-search"]') && $('span[class^="k-icon k-i-search"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-search"]'), { icon: 'search' }); }
        if ($('span[class^="k-icon k-i-file-txt"]') && $('span[class^="k-icon k-i-file-txt"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-file-txt"]'), { icon: 'file-txt' }); }
        if ($('span[class^="k-icon k-i-hyperlink-open-sm"]') && $('span[class^="k-icon k-i-hyperlink-open-sm"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-hyperlink-open-sm"]'), { icon: 'hyperlink-open-sm' }); }
        if ($('span[class^="k-icon k-i-track-changes-accept-all"]') && $('span[class^="k-icon k-i-track-changes-accept-all"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-track-changes-accept-all"]'), { icon: 'track-changes-accept-all' }); }
        if ($('span[class^="k-icon k-i-file-wrench"]') && $('span[class^="k-icon k-i-file-wrench"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-file-wrench"]'), { icon: 'file-wrench' }); }
        if ($('span[class^="k-icon k-i-page-properties"]') && $('span[class^="k-icon k-i-page-properties"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-page-properties"]'), { icon: 'file-wrench' }); }
        if ($('span[class^="k-icon k-i-check-circle"]') && $('span[class^="k-icon k-i-check-circle"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-check-circle"]'), { icon: 'check-circle' }); }
        if ($('span[class^="k-icon k-i-clock"]') && $('span[class^="k-icon k-i-clock"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-clock"]'), { icon: 'clock' }); }
        if ($('span[class^="k-icon k-i-lock"]') && $('span[class^="k-icon k-i-lock"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-lock"]'), { icon: 'lock' }); }
        if ($('span[class^="k-icon k-i-menu"]') && $('span[class^="k-icon k-i-menu"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-menu"]'), { icon: 'menu' }); }
        if ($('span[class^="k-icon k-i-caret-alt-down"]') && $('span[class^="k-icon k-i-caret-alt-down"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-caret-alt-down"]'), { icon: 'caret-alt-down' }); }
        if ($('span[class^="k-icon k-i-arrow-60-down"]') && $('span[class^="k-icon k-i-arrow-60-down"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-arrow-60-down"]'), { icon: 'caret-alt-down' }); }
        if ($('span[class^="k-icon k-i-gears"]') && $('span[class^="k-icon k-i-gears"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-gears"]'), { icon: 'gears' }); }
        if ($('span[class^="k-icon k-i-unlock"]') && $('span[class^="k-icon k-i-unlock"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-unlock"]'), { icon: 'unlock' }); }
        if ($('span[class^="k-icon k-i-map-marker-target"]') && $('span[class^="k-icon k-i-map-marker-target"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-map-marker-target"]'), { icon: 'map-marker-target' }); }
        if ($('span[class^="k-icon k-i-marker-pin-target"]') && $('span[class^="k-icon k-i-marker-pin-target"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-marker-pin-target"]'), { icon: 'map-marker-target' }); }
        if ($('span[class^="k-icon k-i-download"]') && $('span[class^="k-icon k-i-download"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-download"]'), { icon: 'download' }); }
        if ($('span[class^="k-icon k-i-book"]') && $('span[class^="k-icon k-i-book"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-book"]'), { icon: 'book' }); }
        if ($('span[class^="k-icon k-i-dictionary-add"]') && $('span[class^="k-icon k-i-dictionary-add"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-dictionary-add"]'), { icon: 'book' }); }
        if ($('span[class^="k-icon k-i-map-marker"]') && $('span[class^="k-icon k-i-map-marker"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-map-marker"]'), { icon: 'map-marker' }); }
        if ($('span[class^="k-icon k-i-marker-pin"]') && $('span[class^="k-icon k-i-marker-pin"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-marker-pin"]'), { icon: 'map-marker' }); }
        if ($('span[class^="k-icon k-i-minus"]') && $('span[class^="k-icon k-i-minus"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-minus"]'), { icon: 'minus' }); }
        if ($('span[class^="k-icon k-i-minus-outline"]') && $('span[class^="k-icon k-i-minus-outline"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-minus-outline"]'), { icon: 'minus-outline' }); }
        if ($('span[class^="k-icon k-i-connector"]') && $('span[class^="k-icon k-i-connector"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-connector"]'), { icon: 'connector' }); }
        if ($('span[class^="k-icon k-i-x-circle"]') && $('span[class^="k-icon k-i-x-circle"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-x-circle"]'), { icon: 'x-circle' }); }
        if ($('span[class^="k-icon k-i-close-circle"]') && $('span[class^="k-icon k-i-close-circle"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-close-circle"]'), { icon: 'x-circle' }); }
        if ($('span[class^="k-icon k-i-info-circle"]') && $('span[class^="k-icon k-i-info-circle"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-info-circle"]'), { icon: 'info-circle' }); }
        if ($('span[class^="k-icon k-i-info"]') && $('span[class^="k-icon k-i-info"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-info"]'), { icon: 'info-circle' }); }
        if ($('span[class^="k-icon k-i-paperclip"]') && $('span[class^="k-icon k-i-paperclip"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-paperclip"]'), { icon: 'paperclip' }); }
        if ($('span[class^="k-icon k-i-clip"]') && $('span[class^="k-icon k-i-clip"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-clip"]'), { icon: 'paperclip' }); }
        if ($('span[class^="k-icon k-i-hyperlink-open-sm"]') && $('span[class^="k-icon k-i-hyperlink-open-sm"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-hyperlink-open-sm"]'), { icon: 'hyperlink-open-sm' }); }
        if ($('span[class^="k-icon k-i-upload"]') && $('span[class^="k-icon k-i-upload"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-upload"]'), { icon: 'upload' }); }
        if ($('span[class^="k-icon k-i-grid-layout"]') && $('span[class^="k-icon k-i-grid-layout"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-grid-layout"]'), { icon: 'grid-layout' }); }
        if ($('span[class^="k-icon k-i-check-circle"]') && $('span[class^="k-icon k-i-check-circle"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-check-circle"]'), { icon: 'check-circle' }); }
        if ($('span[class^="k-icon k-i-button"]') && $('span[class^="k-icon k-i-button"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-button"]'), { icon: 'button' }); }
        if ($('span[class^="k-icon k-i-arrow-rotate-cw-small"]') && $('span[class^="k-icon k-i-arrow-rotate-cw-small"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-arrow-rotate-cw-small"]'), { icon: 'arrow-rotate-cw-small' }); }
        if ($('span[class^="k-icon k-i-reset"]') && $('span[class^="k-icon k-i-reset"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-reset"]'), { icon: 'calculator' }); }
        if ($('span[class^="k-icon k-i-calculator"]') && $('span[class^="k-icon k-i-calculator"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-calculator"]'), { icon: 'calculator' }); }
        if ($('span[class^="k-icon k-i-reload"]') && $('span[class^="k-icon k-i-reload"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-reload"]'), { icon: 'arrow-rotate-cw-small' }); }
        if ($('span[class^="k-icon k-i-hyperlink-open"]') && $('span[class^="k-icon k-i-hyperlink-open"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-hyperlink-open"]'), { icon: 'hyperlink-open-sm' }); }
        if ($('span[class^="k-icon k-i-hyperlink-open-sm"]') && $('span[class^="k-icon k-i-hyperlink-open-sm"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-hyperlink-open-sm"]'), { icon: 'hyperlink-open-sm' }); }
        if ($('span[class^="k-icon k-i-file-excel"]') && $('span[class^="k-icon k-i-file-excel"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-file-excel"]'), { icon: 'file-excel' }); }
        if ($('span[class^="k-icon k-i-excel"]') && $('span[class^="k-icon k-i-excel"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-excel"]'), { icon: 'file-excel' }); }
        if ($('span[class^="k-icon k-i-copy"]') && $('span[class^="k-icon k-i-copy"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-copy"]'), { icon: 'copy' }); }
        if ($('span[class^="k-icon k-i-file-pdf"]') && $('span[class^="k-icon k-i-file-pdf"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-file-pdf"]'), { icon: 'file-pdf' }); }
        if ($('span[class^="k-icon k-i-pdf"]') && $('span[class^="k-icon k-i-pdf"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-pdf"]'), { icon: 'file-pdf' }); }
        if ($('span[class^="k-icon k-i-globe-outline"]') && $('span[class^="k-icon k-i-globe-outline"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-globe-outline"]'), { icon: 'globe-outline' }); }
        if ($('span[class^="k-icon k-i-globe"]') && $('span[class^="k-icon k-i-globe"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-globe"]'), { icon: 'globe' }); }
        if ($('span[class^="k-icon k-i-dollar"]') && $('span[class^="k-icon k-i-dollar"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-dollar"]'), { icon: 'dollar' }); }
                if ($('span[class^="k-icon k-i-kpi-status-deny"]') && $('span[class^="k-icon k-i-kpi-status-deny"]').length > 0) { kendo.ui.icon($('span[class^="k-icon k-i-kpi-status-deny"]'), { icon: 'kpi-status-deny' }); }
    },
    ...
    encodeNGLReservedCharacters: function (sVal) {
        if (typeof (sVal) !== 'undefined' && typeof (sVal) === 'string' && sVal !== null) {
            ...
            sVal = sVal.replace(".", String.fromCharCode(202));
        } else { sVal = ''; }
        return sVal;
    },
    ...
    convertTime: function (dtVal) {
       // Modified by RHR for v-8.5.2.006 on 12/28/2022 added convertTime to fix issue with KendoDatePicker not loading time properly
        if (dtVal) {
    ...
    convertTimePickerToDateString: function (sVal, sDateString, sDefault) {
        ...
        if (isNaN(timestamp) == false) {
            ...
            //var sMIn = d.getMinutes().toString();
            //if (sMIn.length < 2) { sMIn = (sMIn + '00').slice(-2); }
            // Modified by RHR for v-8.5.2.006 on 12/28/2022 fixed padding issues, need leading zeros in datetime values
            var sHour = ngl.padString(d.getHours().toString(), '0', 2, true)
            var sMIn = ngl.padString(d.getMinutes().toString(), '0', 2, true)
            var sSec = ngl.padString(d.getSeconds().toString(), '0', 2, true)
            var sRet = sDateString.concat(" ", sHour, ":", sMIn, ":", sSec);
            return sRet;
        } else { return sDefault; }
    },
    ...
    convertDateTimeToDateString: function (sVal, sDefault, seperator) {
        //debugger;
        ...
        if (isNaN(timestamp) == false) {
            ...
            var sMIn = ngl.padString(d.getMinutes().toString(), '0', 2, true)
            var sSec = ngl.padString(d.getSeconds().toString(), '0', 2, true)
            var sRet = sMonth.concat(seperator, sDay, seperator, sYear, " ", sHour, ":", sMIn, ":", sSec) // sHour.concat(":", sMIn);
            
            return sRet;
        } else { return sDefault; }
    },
    padString: function (sVal, sPad, iFill, bPadLeft) {
        // Created by RHR for v-8.5.2.006 on 12/28/2022 
        // fills string with leading or trailing values based on sPad and iFill parameters
        var iPad = 0
        while (iPad < iFill) {
            iPad++;
            if (sVal.length < iPad) {
    ...
    formatPhoneNumber: function (strPhone) {
        ...
        //Modified by RHR for v-8.5.4.005 on 04/05/2024 remove phone format for international
    ...
    pgNavigation: function (sBtnId, isKeySelected,iparent) {
        // created by RHR for v-8.5.2.006 on 12/22/2022 added page navigation method
        // this version is typically for Load Board links but could be expanded to 
        // support other pages as well.  Requires a navigation button menu
        if (isKeySelected != true) { return;}
        switch (sBtnId) {
            case "btnOpenLane":
            ...
            case "btnOpenCarrier":
                ...
                break;
            case "btnOpenRevFees":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    location.href = "LoadBoardRevenueFees";
                } else {
                    location.href = "LoadBoardRevenueFees?parent=" + iparent.toString();
                }
                break;
            case "btnOpenRevenue":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    ...
                    location.href = "LoadBoardRevenue?parent=" + iparent.toString();
                }
                break;
            case "btnOpenItem":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    ...
                    location.href = "LoadBoardItems?parent=" + iparent.toString();
                }                
                break;
            case "btnOpenLoadRevenue":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    location.href = "LoadBoardLoadRevenue";
                } else {
                    location.href = "LoadBoardLoadRevenue?parent=" + iparent.toString();
                }  
                break;
            case "btnOpenLoadStatus":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    location.href = "LoadBoardLoadStatus";
                } else {
                    location.href = "LoadBoardLoadStatus?parent=" + iparent.toString();
                }  
                break;
            case "btnOpenLoadNotes":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    location.href = "LoadBoardNotes";
                } else {
                    location.href = "LoadBoardNotes?parent=" + iparent.toString();
                }  
                break;
            case "btnOpenLoadCarData":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    location.href = "LoadBoardCarrierData";
                } else {
                    location.href = "LoadBoardCarrierData?parent=" + iparent.toString();
                }  
                break;
            case "btnOpenDAT":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                ...
                //    location.href = "DAT";
                //} else {
                //    location.href = "DAT?parent=" + iparent.toString();
                //}  
                break;
            case "btnOpenLoadFinancial":
                // modified by RHR forfor v-8.5.4.004 on 12/06/2023
                if (ngl.isNullOrUndefined(iparent) == true) {
                    location.href = "LoadBoardFinancial";
                } else {
                    location.href = "LoadBoardFinancial?parent=" + iparent.toString();
                }  
                break;
            case "btnOpenLoadBoard":
                location.href = "LoadBoard";
                break;
            case "btnOpenLoadStatusBoard":
                location.href = "LoadStatusBoard";
                break;
            case "btnOpenLoadConsSummary":
                location.href = "LoadConsSummary";
                break;
            default:
                return;
        }
    },
    showNGLTooltipOnWindow: function (event, sMsg, win) {
        $('#NGLTooltip').remove();
        //console.log("targetx:" + $(event.target).offset().left)
        //console.log("targety:" + $(event.target).offset().top)
        //console.log("winx:" + win.offset().left)
        //console.log("winy:" + win.offset().top)
        var stooltipX = (($(event.target).offset().left - win.offset().left) ).toString() + 'px';
        var stooltipY = (($(event.target).offset().top - win.offset().top) - 50).toString() + 'px';
        win.append("<div id='NGLTooltip'  style='position:absolute; top:" + stooltipY + "; left:" + stooltipX + "; width:200; heigh:auto;'>" + sMsg + "</div>");      
    },
    showNGLTooltip: function (event, sMsg,elmt) {        
        $('#NGLTooltip').remove();
        // note: look at showNGLTooltipOnWindow logic,  may need to adjust x and y
        var stooltipX = (event.pageX - 20).toString() + 'px';
        var stooltipY = (event.pageY - 150).toString() + 'px';
        let divActive = $(elmt.parentNode); //jquery obj;
        divActive.append("<div id='NGLTooltip'  style='position:absolute; top:" + stooltipY + "; left:" + stooltipX + "; width:200; heigh:auto;'>" + sMsg + "</div>");

     },
    hideNGLTooltip: function () {                  
         $('#NGLTooltip').remove();
    },
    coreSuccessCallBack: function (data, errTitle, refresh) {
        try {
    ...
    coreErrorCallBack: function (xhr, textStatus, error, errTitle) {
...
//Note changes to this enum should also be applied to the same enum in the NGLLookupDataProvider DAL library
var nglStaticLists = {
    UOM: 0,
    LaneTran: 1,
    TempType: 2,
    ...
    TaskMonths: 94,
    TaskWeekDays: 95,
    ParProcOptType: 96, //added by RHR for v-8.5.4.001 
    ChkDigAlgName: 97, //added by RHR for v-8.5.4.001 
    CostAdjType: 98,    //added by RHR for v-8.5.4.001 
    SSOAType: 99, //updaed by RHR for v-8.5.4.004    
    APIUOMCodes: 100 //added by RHR for v-8.5.4.004
}
...
var nglUserDynamicLists = {
    ...
    SSOALEConfigs: 40 //Created by RHR for v-8.5.4.004 on 12/27/2023
}
...
var nglGlobalDynamicLists = {
    ...
    AvailableZoneStates: 13, //Added By ManoRama On 25-AUG-2020 for Carrier Fuel Index Maint Changes
    LECarrierOrAny: 14, //Added By RHR for v-8.5.0.001 on 11/01/2021 --> Returns Any for zero and a list of Carriers that have been assigned to the LECarrier table for the provided LE
    TariffAvailableHDM: 15, //Added By RHR for v-8.5.0.001 on 11/08/2021 -->  Used to select the available HDM Fees not already assigned to the calling tariff ; the caller must filter by CarrTarControl
    tblImageTypeCode: 16 //Modified by RHR for v-8.5.4.003 on 10/24/2023
...
function expandFastTab(ExpandID, CollapseID, HeaderID, DetailID) {
    try {
        if (typeof (HeaderID) != 'undefined' && ngl.isNullOrWhitespace(HeaderID) == false) { $("#" + HeaderID).show(); }
        if (typeof (DetailID) != 'undefined' && ngl.isNullOrWhitespace(DetailID) == false) { $("#" + DetailID).show(); }
        if (typeof (ExpandID) != 'undefined' && ngl.isNullOrWhitespace(ExpandID) == false) { $("#" + ExpandID).hide(); }
        if (typeof (CollapseID) != 'undefined' && ngl.isNullOrWhitespace(CollapseID) == false) { $("#" + CollapseID).show(); }
...
function collapseFastTab(ExpandID, CollapseID, HeaderID, DetailID) {
    try {        
        if (typeof (HeaderID) != 'undefined' && ngl.isNullOrWhitespace(HeaderID) == false) { $("#" + HeaderID).hide();  }
        if (typeof (DetailID) != 'undefined' && ngl.isNullOrWhitespace(DetailID) == false) { $("#" + DetailID).hide(); }
        if (typeof (ExpandID) != 'undefined' && ngl.isNullOrWhitespace(ExpandID) == false) { $("#" + ExpandID).show();  }
        if (typeof (CollapseID) != 'undefined' && ngl.isNullOrWhitespace(CollapseID) == false) { $("#" + CollapseID).hide(); }
       /* $("#" + ExpandID).closest('.fast-tab').css('background-color', 'LightGrey');*/
    }
    catch (err) { ngl.showErrMsg("Collapse Error", err, null); }
}
...
function UpdateUserPageDetailColumnWidth(iPageDetPageControl, iPageDetControl, iPageDetWidth, blnSettingsExist, kNGLGrid) {
    ...
    //    if (typeof (tPage["showPageSpinner"]) !== 'undefined' && ngl.isFunction(tPage["showPageSpinner"])) { tPage["showPageSpinner"](kNGLGrid); }
    //}
    //Modified by RHR testing if reload is still required?
    //    ngl.showInfoNotification("Page Reload Required", "Please wait while the page is reloaded", null);
        if (typeof (tPage["showPageSpinner"]) !== 'undefined' && ngl.isFunction(tPage["showPageSpinner"])) { tPage["showPageSpinner"](kNGLGrid); }
    setTimeout(function () {
    ...
    }, 100); //we have to setTrimeout in order for the spinner to work properly (also the spinner works better when the ajax is async)
}
...
// kendoNGLGrid kendo widget extensions
//custom kendo grid
    ...
    var NGLGrid = kendo.ui.Grid.extend({
        ...
        _initToolbarColumnMenu: function () {
            ...
            if (this.options.toolbarColumnMenu === true && this.element.find(".k-ext-grid-columnmenu").length === 0) {
                ...
                var $menu = $("<ul style='height:200px; left:-1px; z-index: 10;'></ul>");
                ...
                for (var idx = 0; idx < cList.length; idx++) {
                    ...
                    if ($.trim(column.title).length > 0 && column.showhide == 1) {
                        ...
                        $menu.append(kendo.format("<li style='max-width:175px;' ><input  type='checkbox' data-index='{0}' data-field='{1}' data-title='{2}' {3}>{4}</li>",
                ...
                this.wrapper.find("div.k-grid-toolbar").css("overflow", "visible").append("<span  style='float:right; width:200px;'>&nbsp;</span><ul class='k-ext-grid-columnmenu' style='float:right; margin-left:auto; margin-right:250px; '><li data-role='menutitle'><span class='k-icon k-i-gear;'></span></li></ul>"); //Grid Columns -- <span class="k-icon k-i-gear"></span>
        ...
        _captureColumnResize: function (e) {
            var column = e.column
            // Modified by RHR for v-8.5.4.006 on 05/13/2024 added debug code for missing column properties PageDetPageControl, PageDetControl, PageDetUserSecurityControl
            //console.log("column resize event fired");
            //console.log(column);
            if (typeof (column) != "undefined" && column != null) {
                try {
...
function menuItemHover() {
    $(document).ready(function () {
        $("span .k-i-x-circle").hover(function () {
