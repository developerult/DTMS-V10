...
function GroupSubTypes() {
    ...
    this.loadDefaultSubTypes = function () {
        ...
        this.addSubType(16, 2, 'kendoMobileSwitch', 'On Off Boolean');
...
function CMPageDetailCtrl() {
    ...
    this.show = function () {
        ...
        if (this.kendoWindowsObjSaveEventAdded === 0) {
            ...
            //Old  Code $("#winNewPageDetail").data("kendoWindow").wrapper.find(".k-i-save").click(function (e) { tObj.add(); });
            $("#winNewPageDetail").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.add(); });
        }
...
function createCMPageCtrl() {
    ...
    this.show = function () {
        ...
        //this.kendoWindowsObj.data("kendoWindow").wrapper.find(".k-i-save").click(function (e) { tObj.save(); });
        if (this.kendoWindowsObjSaveEventAdded === 0) {
            //Modified by RHR for Kendo v-2018 xxx must reference .parent() on save button click.
            $("#winNewPage").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { tObj.save(); });
        }
        this.kendoWindowsObjSaveEventAdded = 1;
    ...
    this.loadDefaults = function (pageVariable, selectCallBack, saveCallBack, closeCallBack, readCallBack) {
        ...
        $("#txtPageDataSource").kendoMobileSwitch();
        $("#txtPageSortable").kendoMobileSwitch();
        $("#txtPagePageable").kendoMobileSwitch();
        $("#txtPageGroupable").kendoMobileSwitch();
        $("#txtPageEditable").kendoMobileSwitch();
...
////        this.data.AutoAcceptOnDispatch = $("#swDispAutoAcceptOnDispatch").data("kendoMobileSwitch").check(); 
////        this.data.EmailLoadTenderSheet = $("#swDispEmailLoadTenderSheet").data("kendoMobileSwitch").check();
...
////            //$("#winDispatchDialog").data("kendoWindow").wrapper.find(".k-i-upload").parent().click(function (e) { e.preventDefault(); tObj.add(); });
////            this.kendoWindowsObj.wrapper.find(".k-i-upload").parent().click(function (e) { e.preventDefault(); tObj.add(); });
////            this.kendoWindowsObj.wrapper.find(".k-i-print").parent().click(function (e) { e.preventDefault(); tObj.print(); });

////            this.kendoWindowsObj.wrapper.find(".k-i-dictionary-add").parent().click(function (e) { e.preventDefault(); tObj.openContactWindow(); }); //Added By LVV on 2/19/2019 for bug fix add Carrier Contact selection to Dispatch
////        }
...
////            $("#swDispAutoAcceptOnDispatch").data("kendoMobileSwitch").check(switchdataItem);
////            switchdataItem = data.EmailLoadTenderSheet;
////            if (switchdataItem !== true) { switchdataItem = false; }
////            $("#swDispEmailLoadTenderSheet").data("kendoMobileSwitch").check(switchdataItem);
...
////            $("#swDispAutoAcceptOnDispatch").kendoMobileSwitch(); 
////            $("#swDispEmailLoadTenderSheet").kendoMobileSwitch();
////            //Added By LVV on 2/19/2019 for bug fix add Carrier Contact selection to Dispatch
...
function DispatchingReportCtrl() {
    ...
    this.show = function () {
        ...
        if (this.kendoWindowsObjUploadEventAdded === 0) {
            $("#winDispRpt").data("kendoWindow").wrapper.find(".k-i-print").parent().click(function (e) { e.preventDefault(); tObj.print(); });
        }
        this.kendoWindowsObjUploadEventAdded = 1;
...
function CompMaintEAWndCtrl() {
    ...
    this.show = function () {
        ...
        if (this.kendoWindowsObjUploadEventAdded === 0) {
            $("#wndCompMaintEA").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.save(); });
        }
        this.kendoWindowsObjUploadEventAdded = 1;
...
function CompContEAWndCtrl() {
    ...
    this.show = function () {
        ...
        if (this.kendoWindowsObjUploadEventAdded === 0) {
            $("#wndCompContEA").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.save(); });
        }
        this.kendoWindowsObjUploadEventAdded = 1;
...
function LaneEAWndCtrl() {
    ...
    this.clearOrigAddressFields = function () {
        ...
        $("#tpEALaneRecHourStart").data("kendoTimePicker").value("");
        $("#tpEALaneRecHourStop").data("kendoTimePicker").value("");
    }
    ...
    this.clearDestAddressFields = function () {
        ...
        $("#tpEALaneDestHourStart").data("kendoTimePicker").value("");
        $("#tpEALaneDestHourStop").data("kendoTimePicker").value("");
    }
    ...
    this.show = function () {
        ...
        if (this.kendoWindowsObjUploadEventAdded === 0) {
            $("#wndLaneEA").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.save(); });
        }
        this.kendoWindowsObjUploadEventAdded = 1;
    ...
    this.edit = function (data) {
        ...
        if (typeof (data) !== 'undefined' && data != null && ngl.isObject(data)) {
            ...
            if ('LaneControl' in data) {
                if (typeof (data.LaneControl) === 'undefined' || data.LaneControl == null || data.LaneControl == 0) { ngl.showErrMsg("LaneControl Required", "LaneControl cannot be 0", null); this.EditError = true; return; }
                ...
                if ('LaneRecHourStart' in data) { $("#tpEALaneRecHourStart").data("kendoTimePicker").value(data.LaneRecHourStart); }
                if ('LaneRecHourStop' in data) { $("#tpEALaneRecHourStop").data("kendoTimePicker").value(data.LaneRecHourStop); }
                //Orig Contacts
                ...
                if ('LaneDestHourStart' in data) { $("#tpEALaneDestHourStart").data("kendoTimePicker").value(data.LaneDestHourStart); }
                if ('LaneDestHourStop' in data) { $("#tpEALaneDestHourStop").data("kendoTimePicker").value(data.LaneDestHourStop); }
                //Dest Contacts
            ...
            //Show CompNumber on Edit but make it readonly
            $("#divLaneNumber").show();
            $("#txtEALaneNumber").data("kendoMaskedTextBox").readonly(true);
...
function CarSetEAWndCtrl() {
    ...
    this.show = function () {
        ...
        if (this.kendoWindowsObjUploadEventAdded === 0) {
            $("#wndCarSet").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.save(); });
        }
        this.kendoWindowsObjUploadEventAdded = 1;
...
function AllFiltersCtrl(saveFilters, gridApiRef) {
    ...
    this.pushToAllFilters = function (f) {
        ...
        if (typeof (f) !== 'undefined' && ngl.isObject(f)) {
            ...
            oFilterGrid = $("#grd" + this.IDKey + "filters").kendoGrid({
                theme: tObj.Theme,
    ...
    this.loadHTML = function () {
        var sHtml = '<div id="' + this.IDKey + 'wrapper">' +
            ...
            '<span style="font - size: small; font - weight:bold;" class="k-icon k-i-arrow-chevron-down"></span></a></span>' +
            ...
            '<span style="font - size: small; font - weight:bold;" class="k-icon k-i-arrow-chevron-up"></span></a></span>' +
        ...
        if (saveFilters == 'True') {
            sHtml += '<div style="margin: 5px 0 15px 0">' +
                ...
                '<input id="filter' + this.IDKey + 'Groups" />' +
                '<input type="text" id="filter' + this.IDKey + 'Name" name="filterName" style="margin-right: 5px;"/>' +
...
function NGLEditWindCtrl() {
    ...
    this.loadHTML = function () {
        ...
        if (typeof (this.ctrlSubTypes) === "undefined" || !ngl.isObject(this.ctrlSubTypes)) { this.ctrlSubTypes = new GroupSubTypes(); }
        this.ctrlSubTypes.addDefaultSubTypesIfNeeded();
        //in the new code we use ajax to append html objects into parents
        ...
        if (typeof (this.dataFields) !== 'undefined' && ngl.isObject(this.dataFields) === true && ngl.isArray(this.dataFields) === true) {
            ...
            $.each(tObj.dataFields, function (index, item) {
                ...
                if (
                    ...
                    //var kswitch = $("#" + item.fieldTagID).data("kendoMobileSwitch");
                    ...
                    //var bchecked = kswitch.check();                   
                    //field = bchecked;
                    field = $("#" + item.fieldTagID).data("kendoMobileSwitch").check();
                } else if (item.fieldGroupSubType === nglGroupSubTypeEnum.NumericTextBox) {
                    var numVal = $("#" + item.fieldTagID).data("kendoNumericTextBox").value();
                    field = ngl.nbrTryParse(numVal, ngl.nbrTryParse(item.fieldDefaultValue, 0));
                } else if (item.fieldGroupSubType === nglGroupSubTypeEnum.DatePicker) {
                    field = $("#" + item.fieldTagID).data("kendoDatePicker").value();
                } else if (item.fieldGroupSubType === nglGroupSubTypeEnum.DateTimePicker) {
    ...
    this.show = function (fk) {
        ...
        try {
            ...
            //if (this.kendoWindowsObjUploadEventAdded === 0) {
            try {
                $("#wnd" + this.IDKey + "Edit").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.save(); });
            } catch (err) {
    ...
    this.read = function (intControl) {
        ...
        if (typeof (intControl) != 'undefined' && intControl != null) {
            ...
            setTimeout(function (tObj) {
                var oCRUDCtrl = new nglRESTCRUDCtrl();
                // Modified by RHR for v-8.5.3.002 on 06/15/2022 added logic for string value on read 
                // the API controller class must handle the zero key value typically by calling 
                // readPagePrimaryStringKey to get the details.
                if (isNaN(intControl)) {
                    if (oCRUDCtrl.read(tObj.API + "/GET", 0, tObj, "readSuccessCallback", "readAjaxErrorCallback") == false) {
                        blnRet = false;
                    }
                } else {
...
function NGLSummaryDataCtrl() {
    ...
    this.loadHTML = function () {
        var tObj = this;
        var sHtml = ' <span id="Expand' + this.IDKey + 'Span" style="display: none;"><a onclick="expandFastTab(\'Expand' + this.IDKey + 'Span\',\'Collapse' + this.IDKey + 'Span\',\'div' + this.IDKey + 'Summary\',\'\');"><span style="font-size: small;font-weight:bold;" class=\'k-icon k-i-arrow-chevron-down\'></span></a></span>' +
            ' <span id="Collapse' + this.IDKey + 'Span" style="display: normal;"><a onclick="collapseFastTab(\'Expand' + this.IDKey + 'Span\',\'Collapse' + this.IDKey + 'Span\',\'div' + this.IDKey + 'Summary\',\'\');"><span style="font-size: small;font-weight:bold;" class=\'k-icon k-i-arrow-chevron-up\'></span></a></span>' +
...
function NGLEditOnPageCtrl() {
    ...
    this.loadHTML = function () {
        ...
        if (typeof (this.dataFields) !== 'undefined' && ngl.isObject(this.dataFields) === true && ngl.isArray(this.dataFields) === true) {
            ...
            $("#" + this.ContainerDivID).html(' <span id="Expand' + this.IDKey + 'Span" style="display: none;"><a onclick="expandFastTab(\'Expand' + this.IDKey + 'Span\',\'Collapse' + this.IDKey + 'Span\',\'div' + this.IDKey + 'Border\',\'\');"><span style="font-size: small;font-weight:bold;" class=\'k-icon k-i-arrow-chevron-down\'></span></a></span>' +
                ' <span id="Collapse' + this.IDKey + 'Span" style="display: normal;"><a onclick="collapseFastTab(\'Expand' + this.IDKey + 'Span\',\'Collapse' + this.IDKey + 'Span\',\'div' + this.IDKey + 'Border\',\'\');"><span style="font-size: small;font-weight:bold;" class=\'k-icon k-i-arrow-chevron-up\'></span></a></span>' +
                ' <span id="sp' + this.IDKey + 'Lbl" style="font-size:small; font-weight:bold">' + this.DataSourceName + '</span>&nbsp;&nbsp;<br />');
            ...
            divBorder.append(kendo.format("<div style='margin:5px;'><span id='sp{0}Lbl' style='font-size:large; font-weight:bold'>{1}</span>&nbsp;&nbsp;<a onclick='{2}.save();' class='k-button' href='#'><span class='k-icon k-i-save'></span>Save</a></div><div id='div{0}InsertOnly' style='padding: 0px 10px 10px 10px; display:none; float: left;'></div><div id='div{0}Edit' style='padding: 0px 10px 10px 10px;'></div>", this.IDKey, this.DataSourceName, this.sNGLCtrlName));
                ...
                if (tObj.blnEditing === true && ((item.fieldVisible === false && item.fieldReadOnly === true) || (item.fieldVisible === false && (item.fieldRequired === false || item.fieldInsertOnly === true)))) {
                    ...
                    if (item.fieldGroupSubType === nglGroupSubTypeEnum.Header1) {
                        ...
                        if (bFloatLeftTableOpen == true) {
                            ...
                            iTableColumns = iTableColumns + 1;
                            //add the item to the  current Float Table row
                            $floattableitemrow.append(kendo.format("<td class='tblResponsive-top'><span id='splock{3}' {0}></span>&nbsp;{2}<textarea rows='2' cols='75' {4} id='{3}' style='height:50px;'></textarea></td>",
                                sReadOnlyClass, item.fieldCaption, sRequiredAsterik, item.fieldTagID, sMaxLength));
                        } else {
                            sFormated = kendo.format("<div style='float: left;'><table class='tblResponsive'><tr><td class='tblResponsive-top' style='max-width:200px; min-width:200px;'><span id='splock{3}' {0}></span>&nbsp;{1}{2}</td></tr><tr><td class='tblResponsive-top' style='max-width:200px; min-width:200px;'><textarea rows='2' cols='75' {4} id='{3}' style='height:50px;'></textarea></td></tr></table></div>",
                                sReadOnlyClass, item.fieldCaption, sRequiredAsterik, item.fieldTagID, sMaxLength);
                        }
                    } else if (typeof (item.fieldMaxlength) !== 'undefined' && item.fieldMaxlength !== null && isEmpty(item.fieldMaxlength) === false && isNaN(item.fieldMaxlength) === false && item.fieldMaxlength > 150) {
...
function SelectContactCtrl() {
    ...
    this.show = function () {
        ...
        try {
            ...
            ////if (this.kendoWindowsObjUploadEventAdded === 0) {
            ////    this.kendoWindowsObj.wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.save(); });
            ////}
            ////this.kendoWindowsObjUploadEventAdded = 1;
            ////this.kendoWindowsObj.center().open();
...
function SelectContactWndCtrl() {
    ...
    this.show = function () {
        ...
        if (this.kendoWindowsObjUploadEventAdded === 0) {
            $("#wndSelectContactWndCtrl").data("kendoWindow").wrapper.find(".k-i-save").parent().click(function (e) { e.preventDefault(); tObj.save(); });
        }
        this.kendoWindowsObjUploadEventAdded = 1;
