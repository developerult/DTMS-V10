...
function AllFiltersCtrl(saveFilters, gridApiRef) {
    ...
    this.pushToAllFilters = function (f) {
        //debugger;
        //alert("pushToAllFilters");
        var tObj = this;
        console.log("push to all filters:")
        console.log(f);
        if (typeof (f) !== 'undefined' && ngl.isObject(f)) {
            ...
            console.log("this.data before push:")
            console.log(this.data);
            fValues.push(f);
            console.log("f-Values After push:")
            this.data.FilterValues = fValues;
            console.log("this.data.FilterValues:")
            console.log(this.data.FilterValues);
            console.log("tObj.data.FilterValues:")
            console.log(tObj.data.FilterValues);

            console.log("this.data after push:")
            console.log(this.data);
            //var oFilterGridDataSource = new kendo.data.DataSource({
            //    data: = fValues;
            //});
            ...
            //oFilterGrid.data("kendoGrid").dataSource.data([]);
            //console.log("kendo data source:")
            //console.log(tObj.data.FilterValues);
            //oFilterGrid.data("kendoGrid").setDataSource(tObj.data.FilterValues);
            oFilterGrid.data("kendoGrid").dataSource.read();
    ...
    this.addFilterDetail = function () {
        ...
        console.log("Adding Filter Detail")
        console.log(f)
        console.log("Adding Filter Detail current data")
        console.log(this.data)
    ...
    this.addFilterDetailOwnFilter = function (filters) {
        ...
        for (const filter of filters) {
            ...
            f.filterFrom = null;
            f.filterTo = null;
            console.log("addFilterDetailOwnFilter")
            console.log(f)
            this.pushToAllFilters(f);
        }
    };
