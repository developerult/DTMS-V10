...
{
    public partial class WhatsNew : NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.WhatsNew;
                refreshUserControl();
                Response.Redirect(System.Configuration.ConfigurationManager.AppSettings["WebBaseURI"] + "/Content/WhatsNew.pdf", false);
                return;
