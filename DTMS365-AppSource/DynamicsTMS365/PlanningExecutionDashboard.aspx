<%@ Page Language="C#" AutoEventWireup="true" Title="Planning & Execution Dashboard" CodeBehind="PlanningExecutionDashboard.aspx.cs" Inherits="DynamicsTMS365.PlanningAndExecutionDashboard" %>

<!DOCTYPE html>

<html>
<head>
    <title>DTMS Planning & Execution Dashboard</title>
    <%=cssReference%>
    <style>
        html,
        body {
...
<body>
    ...
    <div id="example" style="height: 100%; width: 100%; margin-top: 2px;">
            ...
            <div id="top-pane">
                <div id="horizontal" style="height: 100%; width: 100%;">
                    ...
                    <div id="center-pane">
                        ...
                        <h3 style="text-align:center; margin: 20px;">Next 14 Days Forcast</h3>
                        ...
                        <div style="display:none">                     
                            <div id="PlanningExecutionDashboardContent" class="ngl-blueBorder">
                                <div style="padding: 10px;">
                                    <div id="editableCont"></div>
                                </div>
                            </div>
                            <div id="PlanningExecutionEditor">
        ...
        <% Response.Write(NGLOAuth2); %>
            ...
            var resGetPlanningExecutionEditableContent = function (data) {
            ...
            function editPageDynamicContent() {
                $("#PlanningExecutionDashboardContent").hide();
                $("#PlanningExecutionEditor").show();
                $("#ContEditor").data("kendoEditor").refresh();
            }

            function getPlanningExecutionEditableContent() {
                ...
                getEditorContentNoAuth(JSON.stringify(rt), resGetPlanningExecutionEditableContent);
            }

            var resSavePlanningExecutionContentEditor = function (data) {
                //set the html page content
                var c = $("#ContEditor").data("kendoEditor").value();
                $("#editableCont").html(c);

                $("#PlanningExecutionEditor").hide();
                $("#PlanningExecutionDashboardContent").show();
            }

            function savePlanningExecutionContentEditor() {
                ...
                saveEditorContent(h, resSavePlanningExecutionContentEditor);
            }

            function cancelPlanningExecutionContentEditor() {
                getPlanningExecutionEditableContent();
                $("#PlanningExecutionEditor").hide();
                $("#PlanningExecutionDashboardContent").show();
            }
                         ...
                         $(".export-pdf").click(function () {
                             ...
                             kendo.drawing.drawDOM($("#center-pane"))
                                 ...
                                 .done(function (data) {
                                     ...
                                     kendo.saveAs({
                                         dataURI: data,
                                         fileName: "PlanningDashboard.pdf",
            ...
            function createChart(data) {
                ...
                $.each(data, function (index, value) {
                    ...
                    let dtString = kendo.toString(new Date(value.LoadDate), "d")
                    barDataDates.push(dtString);
                });
               

                $("#chart").kendoChart({
                    title: {
                        text: "Loads Planned to Ship by Date"
                    },
                    series: [{
                        type: "bar",
                        data: barDataValues,
            ...
            $(document).ready(() =>
                $.ajax({
                    async: true,
                    type: 'GET',
                    url: `/api/CompDashboard/GetPlanningDashboard`,
