...
{
    public partial class RateShopping : NGLWebUIBaseClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                PageControl = (int)Utilities.PageEnum.RateShopping;
                refreshUserControl();

                double dblCarrierCostUpchargeLimitVisibility = Utilities.GetParValueByLegalEntity("CarrierCostUpchargeLimitVisibility", this.SSOR.UserLEControl);
                if (DynamicsTMS365.Controllers.SSOAController.isUserRateShopRestricted(this.SSOR.UserName, dblCarrierCostUpchargeLimitVisibility)){
                    Response.Redirect(System.Configuration.ConfigurationManager.AppSettings["WebBaseURI"] + "/RateShoppingQ.aspx", false);
