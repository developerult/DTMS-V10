...
{
    public partial class _Default : NGLWebUIBaseClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {                
                PageControl = (int)Utilities.PageEnum.Home;
                refreshUserControl();
                ...
                //The Default (Home) page is the same for everyone and is always visible
