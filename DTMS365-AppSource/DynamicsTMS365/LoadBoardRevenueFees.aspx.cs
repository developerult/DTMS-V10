...
{
    public partial class LoadBoardRevenueFees : NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.LoadBoardRevenueFees;
                refreshUserControl();
                ...
                else
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(sParent))
                    {
                        ...
                        sRedirect = WebBaseURI + "LoadBoardRevenueFees?parent=" + sParent;
                    }
                    else
                    {
