<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewer.aspx.cs" Inherits="DynamicsTMS365.ReportViewer" %>
...
<html>
    ...
    <script>
        ...
        //rs:Command=Render&UserName=ngl\rramsey&Enter_PRO_Number=NOD-1-1212

        function renderLoadTenderReport(name, control) {
            var ireport = $('#ifReport');
            if (ireport != null) {
                var url = location.protocol + "//" + location.host + "/ViewReport.aspx?hideHeader=true&reportname=CAR106-Load Tender Sheet&reportcontrol=224&refreshReport=true&UN=" + localStorage.NGLvar1455 + "&PAR1=Enter_PRO_Number&PAR1Val=NOD-1-1212";
                console.log(url);
                ireport.attr('src', url);
            }
        }
        ...
        $(document).ready(function () {         
            ...
            //http://www.dynamicstms365.com/ReportServer/Pages/ReportViewer.aspx?%2fFMStd365Reports%2fCAR106-Load%20Tender%20Sheet&rs:Command=Render&UserName=ngl\rramsey&Enter_PRO_Number=NOD-1-1212
            renderLoadTenderReport();


            /*renderReport('CAR007-Carrier Master Address', 146);*/
        });
    </script>
          <style>           
