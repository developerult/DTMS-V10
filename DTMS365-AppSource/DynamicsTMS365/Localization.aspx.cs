...
{
    /// <summary>
    /// Text Localization Maintenance Page
    /// </summary>
    /// <remarks>
    /// Created by RHR for v-8.0 on 01/15/2017
    /// </remarks>
    public partial class Localization : NGLWebUIBaseClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.Localization;
                refreshUserControl();
