<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadConsSummary.aspx.cs" Inherits="DynamicsTMS365.LoadConsSummary" %>

<!DOCTYPE html>

<html>
<head>
    <title>DTMS Load Consolidation Summary </title>
    <%=cssReference%>
    <style>
        html,
        body {
    ...
    <div id="example" style="height: 100%; width: 100%; margin-top: 2px;">
        ...
        <% Response.Write(PageCustomJS); %>
            ...
            function getBookProNumber() {
                try {
                    LoadConsSummaryGridSelectedRow = oLoadConsSummaryGrid.select();
                    if (typeof (LoadConsSummaryGridSelectedRow) === 'undefined' || LoadConsSummaryGridSelectedRow == null) { ngl.showValidationMsg("Booking Record Required", "Please select a Booking to continue", tPage); return false; }
                    LoadConsSummaryGridSelectedRowDataItem = oLoadConsSummaryGrid.dataItem(LoadConsSummaryGridSelectedRow); //Get the dataItem for the selected row
                    if (typeof (LoadConsSummaryGridSelectedRowDataItem) === 'undefined' || LoadConsSummaryGridSelectedRowDataItem == null) { ngl.showValidationMsg("Booking Record Required", "Please select a Booking to continue", tPage); return false; }
                    if ("BookProNumber" in LoadConsSummaryGridSelectedRowDataItem) {
                        //debugger;
                        var blnUpdateSummary = true;
                        var iOldBookPK = iBookPK;
                        iBookPK = LoadConsSummaryGridSelectedRowDataItem.BookControl;
                        if ("BookConsPrefix" in LoadConsSummaryGridSelectedRowDataItem) {
                            sSelectedCNS = LoadConsSummaryGridSelectedRowDataItem.BookConsPrefix;
                        }
                        if (iBookPK == iOldBookPK) { blnUpdateSummary = false; };
                        var setting = { name: 'pk', value: iBookPK.toString() };
                        var oCRUDCtrl = new nglRESTCRUDCtrl();
                        var blnRet = oCRUDCtrl.update("LoadConsSummary/PostPageSetting", setting, tPage, "savePostPageSettingSuccessCallback", "savePostPageSettingAjaxErrorCallback", tPage);
                        ...
                        if ("BookTranCode" in LoadConsSummaryGridSelectedRowDataItem) {
                            var tranCode = LoadConsSummaryGridSelectedRowDataItem.BookTranCode;
            ...
            function saveBookPK() {
                try {
                    ...
                    LoadConsSummaryGridSelectedRowDataItem = oLoadConsSummaryGrid.dataItem(LoadConsSummaryGridSelectedRow); //Get the dataItem for the selected row
                    if (typeof (LoadConsSummaryGridSelectedRowDataItem) === 'undefined' || LoadConsSummaryGridSelectedRowDataItem == null) { ngl.showValidationMsg("Booking Record Required", "Please select a Booking to continue", tPage); return false; }
                    if ("BookControl" in LoadConsSummaryGridSelectedRowDataItem) {
                        //debugger;
                        var blnUpdateSummary = true;
                        var iOldBookPK = iBookPK;
                        iBookPK = LoadConsSummaryGridSelectedRowDataItem.BookControl;
            ...
            function execActionClick(btn, proc) {
                //debugger;          
                if (btn.id == "btnAddBooking") { openAddNewLoadConsSummaryGridWindow(); } 
                    ...
                    if (isBookingSelected() === true) {
                        if ("BookODControl" in LoadConsSummaryGridSelectedRowDataItem) {
                            
                            var lanePK = LoadConsSummaryGridSelectedRowDataItem.BookODControl;
                    ...
                    //debugger;
                    if (isBookingSelected() === true) {
                        if ("BookCustCompControl" in LoadConsSummaryGridSelectedRowDataItem) {
                            var compPK = LoadConsSummaryGridSelectedRowDataItem.BookCustCompControl;
                    ...
                    if (typeof (tPage[proc]) !== 'undefined' && ngl.isObject(tPage[proc])) {
                        ...
                        //tPage[proc].close();
                        //oLoadConsSummaryGrid.dataSource.read();
                        //if (blnShowRateItAfterBookingOptions === true) {
                        //    var iThisBookControl = iBookPK;
                        //    execActionClick("Refresh");
                        //    var oRow = oLoadConsSummaryGrid.table.find('tr[data-id="' + iBookPK + '"]');
                        //    if (typeof (oRow) !== 'undefined' && ngl.isObject(oRow)) {
                        //        oLoadConsSummaryGrid.select(oRow);
                        //        saveBookPK();
                    ...
                    if (isBookingSelected() === true) {
                        if ("BookODControl" in LoadConsSummaryGridSelectedRowDataItem) {
                            var LaneControl = LoadConsSummaryGridSelectedRowDataItem.BookODControl;
                    ...
                    if (isBookingSelected() === true) {
                        if ("BookCustCompControl" in LoadConsSummaryGridSelectedRowDataItem){
                            var compControl = LoadConsSummaryGridSelectedRowDataItem.BookCustCompControl;                           
                    ...
                    var intGridRecords = oLoadConsSummaryGrid.dataSource.total();
                ...
                else { ngl.pgNavigation(btn.id, isBookingSelected(), iBookPK); }// modified by RHR for v-8.5.4.004 on 12/06/2023 added updated page navigation menu method
            ...
            function openLoadTenderReport() {
                ...
                var pro = "";
                if ("BookProNumber" in LoadConsSummaryGridSelectedRowDataItem) { pro = LoadConsSummaryGridSelectedRowDataItem.BookProNumber; }
            ...
            function createNewClaim() {
                ...
                kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                var oCRUDCtrl = new nglRESTCRUDCtrl();
            ...
            function refresh() { ngl.readDataSource(oLoadConsSummaryGrid); }

            var blnLoadConsSummaryGridChangeBound = false;
            //*************  Call Back Functions ****************
            // Modified by CHA v-8.5 on 06/22/2021
            // Example of how callbacks can be used

            function LoadConsSummaryGridDragStartCallBack(draggedObject, event) {
                //debugger;
                //console.log('Drag start - LoadConsSummary page!');
            ...
            function LoadConsSummaryGridDropCallBack(draggedObject, droppedObject, isDraggingUp) {
                //console.log('Drop - LoadConsSummary page!');
                //console.log(draggedObject);
                ...
                const Orders = new BookLoadConsSummaryDropped();
                Orders.draggedObject = draggedObject;
                Orders.droppedObject = droppedObject
                Orders.isDraggingUp = isDraggingUp;
                var oCRUDCtrl = new nglRESTCRUDCtrl();
                var blnRet = oCRUDCtrl.update("LoadConsSummary/PostGridDrop", Orders, tPage, "PostGridDropSuccessCallback", "PostGridDropAjaxErrorCallback", false);

            }
            function BookLoadConsSummaryDropped() {
                draggedObject: null;
                droppedObject: null;
                isDraggingUp: false;              

            }
            var sLoadConsSummaryGridKey = '';
            function LoadConsSummaryGridDataBoundCallBack(e, tGrid, sKey) {
                sLoadConsSummaryGridKey = sKey;
                oLoadConsSummaryGrid = tGrid;
                if (blnLoadConsSummaryGridChangeBound == false) {
                    oLoadConsSummaryGrid.bind("change", saveBookPK);
                    blnLoadConsSummaryGridChangeBound = true;
                }
                ...
                if (typeof (iBookPK) !== 'undefined' && iBookPK !== null && iBookPK !== 0) {
                    var rows = oLoadConsSummaryGrid.items();
                    $(rows).each(function (e) {
                        var row = this;
                        var dataItem = oLoadConsSummaryGrid.dataItem(row);
                        if (dataItem.BookControl == iBookPK) {
                            oLoadConsSummaryGrid.select(row);
                            //Modified by RHR for v-8.5.4.001 on 05/30/2023 updated the selected LoadConsSummaryGridSelectedRowDataItem with the current record.
                            // updated some other dependent variables as well.
                            LoadConsSummaryGridSelectedRowDataItem = dataItem;
                            if ("BookConsPrefix" in LoadConsSummaryGridSelectedRowDataItem) {
                                sSelectedCNS = LoadConsSummaryGridSelectedRowDataItem.BookConsPrefix;
                            }                           
                            //check if the TranCode is PB or PC and enable or disable the Print BOL action button (We can print the BOL for both PB or PC)  
                        ...
                        //    var newRows = oLoadConsSummaryGrid.table.find('tr');
                        ...
                        //    //var cRow = oLoadConsSummaryGrid.table.find('tr[data-id="' + dataItem.BookControl + '"]');
            ...
            function AcceptAll(iRet) {
                ...
                if (!ngl.isNullOrWhitespace(sLoadConsSummaryGridKey)) {
                    var sfilterFuncionname = "obj" + sLoadConsSummaryGridKey + "Filters"
                    var s = window[sfilterFuncionname].data;
                    kendo.ui.progress($("#center-pane"), true);
                    setTimeout(function (tObj) {
                        var oCRUDCtrl = new nglRESTCRUDCtrl();
                        var blnRet = oCRUDCtrl.filteredRead("LoadConsSummary/AcceptAllRecords", s, tPage, "AcceptAllSuccessCallback", "AcceptAllAjaxErrorCallback", false);
                    }, 10, tObj);
                } else {
            ...
            function getAvailableBookingActions() {
                ...
                if ("BookControl" in LoadConsSummaryGridSelectedRowDataItem) { bkControl = LoadConsSummaryGridSelectedRowDataItem.BookControl; }
                if ("BookTranCode" in LoadConsSummaryGridSelectedRowDataItem) { tranCode = LoadConsSummaryGridSelectedRowDataItem.BookTranCode; }
                if ("BookDateOrdered" in LoadConsSummaryGridSelectedRowDataItem) { dtOrdered = LoadConsSummaryGridSelectedRowDataItem.BookDateOrdered; }
                if ("BookDateRequired" in LoadConsSummaryGridSelectedRowDataItem) { dtRequired = LoadConsSummaryGridSelectedRowDataItem.BookDateRequired; }
                if ("BookDateLoad" in LoadConsSummaryGridSelectedRowDataItem) { dtLoad = LoadConsSummaryGridSelectedRowDataItem.BookDateLoad; }
                if ("BookFinARInvoiceDate" in LoadConsSummaryGridSelectedRowDataItem) { dtInvoice = LoadConsSummaryGridSelectedRowDataItem.BookFinARInvoiceDate; }
                if ("BookCarrierControl" in LoadConsSummaryGridSelectedRowDataItem) { carrierControl = LoadConsSummaryGridSelectedRowDataItem.BookCarrierControl; }
                if ("BookLockAllCosts" in LoadConsSummaryGridSelectedRowDataItem) { lockAllCosts = LoadConsSummaryGridSelectedRowDataItem.BookLockAllCosts; }
                if ("BookSHID" in LoadConsSummaryGridSelectedRowDataItem) { shid = LoadConsSummaryGridSelectedRowDataItem.BookSHID; }
                if ("BookDateDelivered" in LoadConsSummaryGridSelectedRowDataItem) { dtDelivered = LoadConsSummaryGridSelectedRowDataItem.BookDateDelivered; }
                if ("BookRouteConsFlag" in LoadConsSummaryGridSelectedRowDataItem) { routeConsFlag = LoadConsSummaryGridSelectedRowDataItem.BookRouteConsFlag; }
                if ("NEXTStop" in LoadConsSummaryGridSelectedRowDataItem) { blnNEXTStop = LoadConsSummaryGridSelectedRowDataItem.NEXTStop; }
                if ("DAT" in LoadConsSummaryGridSelectedRowDataItem) { blnDAT = LoadConsSummaryGridSelectedRowDataItem.DAT; }
            ...
            function readyToAssignCarrier() {
                //Get the dataItem for the selected row
                var iRet = 1;
                if (typeof (LoadConsSummaryGridSelectedRowDataItem) === 'undefined' || LoadConsSummaryGridSelectedRowDataItem == null) { ngl.showValidationMsg("Booking Record Required", "Please select a Booking to continue", tPage); return -1; }
                var bkControl = 0, carrierControl = 0, routeConsFlag = 0;
                var tranCode = "", dtOrdered = "", dtRequired = "", dtLoad = "", dtInvoice = "", dtDelivered = "", shid = "";
                ...
                if ("BookDateDelivered" in LoadConsSummaryGridSelectedRowDataItem) { dtDelivered = LoadConsSummaryGridSelectedRowDataItem.BookDateDelivered;  }
                if ("BookRouteConsFlag" in LoadConsSummaryGridSelectedRowDataItem) { routeConsFlag = LoadConsSummaryGridSelectedRowDataItem.BookRouteConsFlag;}
                if ("OnCreditHold" in LoadConsSummaryGridSelectedRowDataItem) { blnOnCreditHold = LoadConsSummaryGridSelectedRowDataItem.OnCreditHold; } //Added By LVV on 7/14/20 for v-8.3.0.001 Task #20200609155542 - Credit Hold
            ...
            function BookingTenderWndCB(oResults) {
                if (oResults.widget.sNGLCtrlName === "wdgtBookingTenderWndDialog" && oResults.source === "saveSuccessCallback") {
                    ...
                    //        var oGrid1 = $('#id621201809251302564013007')  //.kendoNGLGrid tPage.oLoadConsSummaryGrid;
                    //        var oGrid = tPage.oLoadConsSummaryGrid;
                    //        //var data = oGrid.data("kendoNGLGrid");
                    //        var oRow6 = tPage.oLoadConsSummaryGrid.table.find('tr[data-id="' + iThisBookControl + '"]')
                    //        if ("BookControl" in oRow6) {
                    //            //tPage.LoadConsSummaryGridSelectedRowDataItem = oRow1;
                    ...
                    //                oGrid.select(oRow);
                    //                //tPage.saveBookPK();
                    //                tPage.LoadConsSummaryGridSelectedRowDataItem = oRow;// oLoadConsSummaryGrid.dataItem(LoadConsSummaryGridSelectedRow);
                    //                if (typeof (tPage.LoadConsSummaryGridSelectedRowDataItem) === 'undefined' || tPage.LoadConsSummaryGridSelectedRowDataItem == null) {
                    //                    ngl.showValidationMsg("Cannot Auto Select the Previous Booking Record ", "Please select a Booking to continue", tPage);
                    //                    return false;
                    //                }
                    //                if ("BookControl" in tPage.LoadConsSummaryGridSelectedRowDataItem) {
                    //                    tPage.iBookPK = tPage.LoadConsSummaryGridSelectedRowDataItem.BookControl;
                    //                    var setting = { name: 'pk', value: iBookPK.toString() };
                    //                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    //                    var blnRet = oCRUDCtrl.update("LoadConsSummary/PostPageSetting", setting, tPage, "savePostPageSettingSuccessCallback", "savePostPageSettingAjaxErrorCallback", tPage);
                    //                } else {
            ...
            function SelectTransLoad(e) {
                ...
                if (isBookingSelected() === true) {
                    ...
                    setTimeout(function (tObj) {
                        var oCRUDCtrl = new nglRESTCRUDCtrl();
                        var blnRet = oCRUDCtrl.filteredRead("LoadConsSummary/GetTransLoad", s, tPage, "GetTransLoadSuccessCallback", "GetTransLoadAjaxErrorCallback", false);
                    }, 10, tObj);
                }
                ...
                //        kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                //        var oCRUDCtrl = new nglRESTCRUDCtrl();
                //        var blnRet = oCRUDCtrl.filteredPost("LoadConsSummary/HoldLoad", iRowBookControl.toString(), tPage, "PostHoldBookingSuccessCallback", "PostHoldBookingAjaxErrorCallback", false);
                //    } else {
                ...
                //        kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                //        var oCRUDCtrl = new nglRESTCRUDCtrl();
                //        var blnRet = oCRUDCtrl.filteredPost("LoadConsSummary/UnHoldLoad", iRowBookControl.toString(), tPage, "PostHoldBookingSuccessCallback", "PostHoldBookingAjaxErrorCallback", false);
            ...
            function BingMapsCaller() {
                var wgt = 0;
                if ("BookTotalWgt" in LoadConsSummaryGridSelectedRowDataItem) { wgt = LoadConsSummaryGridSelectedRowDataItem.BookTotalWgt; }
                MapIt(iBookPK, wgt);
            }

            function coreErrorCallBack(xhr, textStatus, error, errTitle) {
                //debugger;
                kendo.ui.progress(oLoadConsSummaryGrid.element, false);
            ...
            function stopResequence(iBookPK) {
                kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                var oCRUDCtrl = new nglRESTCRUDCtrl();
                var blnRet = oCRUDCtrl.read("LoadConsSummary/StopResequence", iBookPK, tPage, "stopResequenceSuccessCallback", "stopResequenceAjaxErrorCallback", true);
            }
            //Start ResetAPExport
            ...
            function ResetAPExport(iBookPK) {
                kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                var oCRUDCtrl = new nglRESTCRUDCtrl();
                var blnRet = oCRUDCtrl.filteredPost("LoadConsSummary/ResetAPExport", iBookPK.toString(), tPage, "ResetAPExportSuccessCallback", "ResetAPExportAjaxErrorCallback", true);
            }
              //end
            ...
            function ConfirmShip(iRet, iBookPK) {
                ...
                kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                var oCRUDCtrl = new nglRESTCRUDCtrl();
                var blnRet = oCRUDCtrl.filteredPost("LoadConsSummary/ConfirmShip", iBookPK.toString(), tPage, "ConfirmShipSuccessCallback", "ConfirmShipAjaxErrorCallback", true);
            }
            ...
            function getMiles(iBookPK) {
                kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                var oCRUDCtrl = new nglRESTCRUDCtrl();
                var blnRet = oCRUDCtrl.read("LoadConsSummary/GetMiles", iBookPK, tPage, "getMilesSuccessCallback", "getMilesAjaxErrorCallback", true);
            }
            ...
            function DuplicatePro(iBookPK) {
                if (isBookingSelected() === true) {
                    kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    var blnRet = oCRUDCtrl.read("LoadConsSummary/DuplicatePro", iBookPK, tPage, "DuplicateProSuccessCallback", "DuplicateProAjaxErrorCallback", true);
            ...
            function NewSequence(iBookPK) {
                if (isBookingSelected() === true) {
                    kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    var blnRet = oCRUDCtrl.read("LoadConsSummary/createNewSequence", iBookPK, tPage, "NewSequenceSuccessCallback", "NewSequenceAjaxErrorCallback", true);
                }
            }
            ...
            function createTransLoad(iBookPK) {
                if (isBookingSelected() === true) {
                    kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    var blnRet = oCRUDCtrl.read("LoadConsSummary/createTransLoad", iBookPK, tPage, "createTransLoadSuccessCallback", "createTransLoadAjaxErrorCallback", true);
                }
            }
            ...
            function Calculate(iBookPK) {
                if (isBookingSelected() === true) {
                    kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    var blnRet = oCRUDCtrl.read("LoadConsSummary/Calculate", iBookPK, tPage, "CalculateSuccessCallback", "CalculateAjaxErrorCallback", true);
                }
            }
            ...
            function RecalculateUsingLineHaul(iBookPK) {
                if (isBookingSelected() === true) {
                    kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    var blnRet = oCRUDCtrl.read("LoadConsSummary/RecalculateUsingLineHaul", iBookPK, tPage, "RecalculateUsingLineHaulSuccessCallback", "RecalculateUsingLineHaulAjaxErrorCallback", true);
                }
            }
            ...
            function UpdateCNS(iBookPK) {
                if (isBookingSelected() === true) {
                    kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    var blnRet = oCRUDCtrl.read("LoadConsSummary/UpdateCNS", iBookPK, tPage, "UpdateCNSSuccessCallback", "UpdateCNSAjaxErrorCallback", true);
                }
            }
            ...
            function StampCNS(iBookPK) {
                if (isBookingSelected() === true) {
                    ...
                    if (sStampingCNS.length > 0) {
                        ...
                        if ((LoadConsSummaryGridSelectedRowDataItem.BookTranCode == "N" || LoadConsSummaryGridSelectedRowDataItem.BookTranCode == "P") && LoadConsSummaryGridSelectedRowDataItem.BookHoldLoad == 0) {
                    ...
                    var blnRet = oCRUDCtrl.filteredRead("LoadConsSummary/getCNSStamp", filter, tPage, "StampCNSSuccessCallback", "StampCNSAjaxErrorCallback", false);
                }
            }
            ...
            function PostUpdateCNS(e) {
                ...
                if (iRowBookControl != 0 && (data.BookTranCode == "N" || data.BookTranCode == "P") && data.BookHoldLoad == 0) {
                    ...
                    kendo.ui.progress(oLoadConsSummaryGrid.element, true);
                    var oCRUDCtrl = new nglRESTCRUDCtrl();
                    var blnRet = oCRUDCtrl.filteredPost("LoadConsSummary/saveStampedCNS", iRowBookControl.toString(), tPage, "PostUpdateCNSSuccessCallback", "PostUpdateCNSAjaxErrorCallback", false);
            ...
            $(document).ready(function () {
                ...
                if (control != 0) {
                    ...
                    getPageSettings(tPage, "LoadConsSummary", "pk", false);
                } 
