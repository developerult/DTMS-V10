...
{
    public partial class LoadBoardNotes : NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.LoadBoardNotes;
                refreshUserControl();
                ...
                else
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(sParent))
                    {
                        ...
                        sRedirect = WebBaseURI + "LoadBoardNotes?parent=" + sParent;
                    }
                    else
                    {
