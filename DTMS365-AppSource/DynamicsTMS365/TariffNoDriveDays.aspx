<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TariffNoDriveDays.aspx.cs" Inherits="DynamicsTMS365.TariffNoDriveDays" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head  >
    <title>DTMS Tariff Non Drive Days</title>        
         <%=cssReference%>             
        <style>
            html,
     ...
     <script>
        ...
        <% Response.Write(NGLOAuth2); %>
         ...
         function execActionClick(btn, proc){
             ...
             }else if (btn.id == "btnAddNoDriveDay" ){ openAddNewTariffNoDriveDaysGridWindow();
