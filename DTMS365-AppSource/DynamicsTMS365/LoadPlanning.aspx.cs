...
{
    public partial class LoadPlanning : NGLWebUIBaseClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.LoadPlanning;
                refreshUserControl();
                ...
                if (UserControl != 0)
                {
                    ...
                    // This code only loads the fast tabs,  not the filters.  we need more advanced logic to load both
                    //pg.createPageDetailsWSharedFilters(PageControl, UserControl, (int)Utilities.PageEnum.LoadBoard);
                }
