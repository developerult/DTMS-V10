...
{
    public class LoadBoardItemController : NGLControllerBase
    {
        #region " Constructors "
        /// <summary>
        /// Created by RHR for v-8.2 on 08/29/2018 initializes the Page property by calling the base class constructor
        /// </summary>
        public LoadBoardItemController()
                : base(Utilities.PageEnum.LoadBoardItems)
	     {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardItemController";
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                Models.BookItem[] records = new Models.BookItem[] { };
                ...
                LTS.BookItem[] oData = new LTS.BookItem[] { };
                oData = oDAL.GetBookItems(f, ref RecordCount);
        ...
        public Models.Response Post([System.Web.Http.FromBody]Models.BookItem data)
        {
            ...
            try
            {
                ...
                int iBookControl = readBookControlPageSetting(0);               
                if (iBookControl == 0)
                {
                ...
                DAL.NGLBookItemData oDAL = new DAL.NGLBookItemData(Parameters);
                LTS.BookItem record = selectLTSData(data);
                bool blnRet = oDAL.SaveOrCreateBookItem(record, iBookControl);
