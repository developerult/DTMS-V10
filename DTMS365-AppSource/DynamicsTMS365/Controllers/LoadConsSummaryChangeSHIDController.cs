...
{
    public class LoadConsSummaryChangeSHIDController : NGLControllerBase
    {
        #region " Constructors "
        /// <summary>
        /// Created by RHR for v-8.2 5.4.004 on 12/05/2023
        /// </summary>
        public LoadConsSummaryChangeSHIDController()
                : base(Utilities.PageEnum.ConsolidationSum)
        {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadConsSummaryChangeSHIDController";
        ...
        public Models.Response GetByParent(int id)
        {
            ...
            try
            {
                if (id == 0)
                {
                    id = readPagePrimaryKey(Parameters, Utilities.PageEnum.ConsolidationSum);
