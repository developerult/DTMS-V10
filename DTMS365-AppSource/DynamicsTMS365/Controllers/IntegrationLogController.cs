...
{
    public class IntegrationLogController : NGLControllerBase
    {

        #region " Constructors "

        public IntegrationLogController()
            : base(Utilities.PageEnum.IntegrationLog)
        {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.IntegrationLogController";
