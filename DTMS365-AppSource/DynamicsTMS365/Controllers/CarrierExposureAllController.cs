...
{
    public class CarrierExposureAllController : NGLControllerBase
    {

        #region " Constructors "

        public CarrierExposureAllController()
            : base(Utilities.PageEnum.CarrierExposureAll)
        {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.CarrierExposureAllController";
