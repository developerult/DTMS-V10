...
namespace DynamicsTMS365.Controllers
{
    ...
    /// when adding a new fuel addendum to a carrier from an existing carrier's fuel
    /// addendum.  this controller actually saves the data as a JSON string to the
    ...
    /// NOTE:  this is only used by the Carrier Fuel pages
    /// 
    /// </summary>
    public class FuelAdTemplCarrierOptionsController : NGLControllerBase
    {
        ...
        /// </summary>
        public FuelAdTemplCarrierOptionsController()
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.FuelAdTemplCarrierOptionsController";
