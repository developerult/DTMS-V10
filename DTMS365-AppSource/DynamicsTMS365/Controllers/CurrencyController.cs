...
{
    public class CurrencyController : NGLControllerBase
    {
        #region " Constructors "
        /// <summary>
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.CurrencyController";
        ...
        private Models.vCurrency selectModelData(LTS.Currency d)
        {
            Models.vCurrency modelRecord = new Models.vCurrency();
            if (d != null)
            {
                List<string> skipObjs = new List<string> { "CurrencyUpdated", "rowguid" };
                string sMsg = "";
                modelRecord = (Models.vCurrency)Ngl.Core.Utility.DataTransformation.CopyMatchingFields(modelRecord, d, skipObjs, ref sMsg);
                ...
                if (modelRecord != null) { modelRecord.setUpdated(d.CurrencyUpdated.ToArray()); }
            }
        ...
        public Models.Response Get(int id)
        {
            ...
            {                
                ...
                DAL.NGLCurrencyData oDAL = new DAL.NGLCurrencyData(Parameters);
                LTS.Currency oData = new LTS.Currency { };
                oData = oDAL.GetCurrenciesbyFiltered(id);
                Models.vCurrency[] records = new Models.vCurrency[1];
                if (oData != null)
                {
                    count = 1;
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                Models.vCurrency[] records = new Models.vCurrency[] { };
                LTS.Currency[] oData = new LTS.Currency[] { };
                oData = oDAL.GetCurrencyFiltered(f, ref RecordCount);
        ...
        public Models.Response Post([System.Web.Http.FromBody]LTS.Currency data)
        {
            var response = new Models.Response(); //new HttpResponseMessage();
            if (!authenticateController(ref response)) { return response; }
            try
            {
                DAL.NGLCurrencyData oDAL = new DAL.NGLCurrencyData(Parameters);
                bool blnRet = oDAL.SaveOrCreateCurrency(data);
        ...
        public Models.Response DELETE(int id)
        {
            ...
            {
                DAL.NGLCurrencyData oDAL = new DAL.NGLCurrencyData(Parameters);
                bool blnRet = oDAL.DeleteCurrency(id);
                bool[] oRecords = new bool[1];
                oRecords[0] = blnRet;
                response = new Models.Response(oRecords, 1);
            }
