...
namespace DynamicsTMS365.Controllers
{
    public class LoadBoardChangeSHIDController : NGLControllerBase
    {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardChangeSHIDController";
