...
namespace DynamicsTMS365.Controllers
{
    public class LookupComCodesController : NGLControllerBase
    {
        ...
        private Models.Codes selectLTSData(LTS.vLookUpComCode d)
        {
            Models.Codes modelRecord = new Models.Codes();
            if (d != null)
            {
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                LTS.vLookUpComCode[] oData1 = new LTS.vLookUpComCode[] { };
                DAL.Models.AllFilters f = new DAL.Models.AllFilters();
                oData1 = oDAL.GetComCodesFiltered(f, ref RecordCount, CodeType).Where(x=>x.ID == id).ToArray();
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
               ...
               // f.ParentControl = readPagePrimaryKey(Parameters, Utilities.PageEnum.StaticListMaint);
                ...
                LTS.vLookUpComCode[] oData = new LTS.vLookUpComCode[] { };
                oData = oDAL.GetComCodesFiltered(f, ref RecordCount, CodeType);
