...
namespace DynamicsTMS365.Controllers
{
    public class LoadBoardRateITController : NGLControllerBase
    {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardRateITController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                //from the database
                LTS.vBookLoadBoard record = new LTS.vBookLoadBoard();
                record.BookControl = id;
                LTS.vBookLoadBoard[] oRecords = new LTS.vBookLoadBoard[1];
                oRecords[0] = record;
        ...
        /// <summary>
        /// Uses the select booking record by user and the RateITWorkFlowOption widget to apply the selected rating to the load
        /// the data parameter is only used to validate that a booking record exists
        /// </summary>
