...
{
    public class BookRevLaneFeesController: NGLControllerBase
    {
        ...
        /// </summary>
        public BookRevLaneFeesController()
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.BookRevLaneFeesController";
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                DAL.NGLBookFeeData oBookFeesDAL = new DAL.NGLBookFeeData(Parameters);
                int count = 0;
                fees = oBookFeesDAL.GetvBookFeesForLane(iBookControl);
