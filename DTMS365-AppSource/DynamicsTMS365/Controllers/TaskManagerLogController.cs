...
{
    public class TaskManagerLogController : NGLControllerBase
    {
        #region " Constructors "

        public TaskManagerLogController()
            : base(Utilities.PageEnum.TaskManagerLog)
        {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.TaskManagerLogController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                if (id != 0)
                {
                    f.filterName = "TaskControl";
                    f.filterValue = id.ToString();
                }

                DAL.NGLtblRunTaskData oDAL = new DAL.NGLtblRunTaskData(Parameters);
                LTS.tblTaskLog[] records = new LTS.tblTaskLog[] { };
                records = oDAL.getTaskLog(f, ref RecordCount);
        ...
        public Models.Response Post([System.Web.Http.FromBody] LTS.vTblRunTask data)
        {
            //create a response message to send back
            var response = new Models.Response(); //new HttpResponseMessage();
            //if (!authenticateController(ref response)) { return response; }
            ...
            //{
            //    DAL.NGLtblRunTaskData oDAL = new DAL.NGLtblRunTaskData(Parameters);
            //    //oDAL.throwInvalidDeleteRequestException
            //    LTS.tblRunTask oChanges = oDAL.selectLTSDataFromView(data);
            //    bool blnRet = oDAL.SavetblRunTask(oChanges);
        ...
        public Models.Response DELETE(int id)
        {
            ...
            //{
            //    DAL.NGLtblRunTaskData oDAL = new DAL.NGLtblRunTaskData(Parameters);
            //    bool blnRet = oDAL.DeletetblRunTask(id);
