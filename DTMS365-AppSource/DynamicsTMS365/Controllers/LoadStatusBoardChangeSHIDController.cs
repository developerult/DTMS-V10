...
{
    public class LoadStatusBoardChangeSHIDController : NGLControllerBase
    {
        #region " Constructors "
        /// <summary>
        /// Created by RHR for v-8.f.4.004 on 12/05/2023
        public LoadStatusBoardChangeSHIDController()
                : base(Utilities.PageEnum.LoadStatusBoard)
    {
    }
    ...
    /// </summary>
    private string _SourceClass = "DynamicsTMS365.Controllers.LoadStatusBoardChangeSHIDController";
    ...
    public Models.Response GetByParent(int id)
    {
        ...
        try
        {
            if (id == 0)
            {
                id = readPagePrimaryKey(Parameters, Utilities.PageEnum.LoadStatusBoard);
