...
{
    public class LoadPlanningQuotesController : NGLControllerBase
    {
        #region " Constructors "
        /// <summary>
        /// Created by RHR for v-8.2 on 05/15/2019 initializes the Page property by calling the base class constructor
        /// </summary>
        public LoadPlanningQuotesController()
                : base(Utilities.PageEnum.LoadPlanningQuotes)
        {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadPlanningQuotesController";
