...
namespace DynamicsTMS365.Controllers
{
    public class LoadStatusBoardController : NGLControllerBase
    {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadStatusBoardController";
