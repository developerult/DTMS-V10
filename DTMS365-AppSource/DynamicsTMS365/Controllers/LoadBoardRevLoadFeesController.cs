...
{
    public class LoadBoardRevLoadFeesController : NGLControllerBase
    {

        #region " Constructors "

        /// <summary>Initializes the Page property by calling the base class constructor</summary>
        public LoadBoardRevLoadFeesController() : base(Utilities.PageEnum.LoadBoardRevenueLoad) { }
        ...
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardRevLoadFeesController";
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                //if (!string.IsNullOrWhiteSpace(filter)) { savePageFilters(filter, "LBRevLdFeesFltr"); } //save the page filter for the next time the page loads
                ...
                oData = oDAL.GetLoadBoardRevLoadFees(id);
                count = oData.Count();
