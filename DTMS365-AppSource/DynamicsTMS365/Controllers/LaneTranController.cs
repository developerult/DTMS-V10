...
namespace DynamicsTMS365.Controllers
{
    public class LaneTranController : NGLControllerBase
    {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LaneTranController";
        ...
        private Models.vLaneTran selectModelData(LTS.LaneTran d)
        {
            Models.vLaneTran modelRecord = new Models.vLaneTran();
            if (d != null)
            {
                List<string> skipObjs = new List<string> { "LaneTransUpdated", "rowguid" };
                string sMsg = "";
                modelRecord = (Models.vLaneTran)Ngl.Core.Utility.DataTransformation.CopyMatchingFields(modelRecord, d, skipObjs, ref sMsg);
                ...
                if (modelRecord != null) { modelRecord.setUpdated(d.LaneTransUpdated.ToArray()); }
            }
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                DAL.NGLLaneTranData oDAL = new DAL.NGLLaneTranData(Parameters);
                LTS.LaneTran oData = new LTS.LaneTran { };
                oData = oDAL.GetLaneTranbyFiltered(id);
                Models.vLaneTran[] records = new Models.vLaneTran[1];
                if (oData != null)
                {
                    count = 1;
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                Models.vLaneTran[] records = new Models.vLaneTran[] { };
                LTS.LaneTran[] oData = new LTS.LaneTran[] { };
                oData = oDAL.GetLaneTranFiltered(f, ref RecordCount);
        ...
        public Models.Response Post([System.Web.Http.FromBody]LTS.LaneTran data)
        {
            var response = new Models.Response(); //new HttpResponseMessage();
            if (!authenticateController(ref response)) { return response; }
            try
            {
                DAL.NGLLaneTranData oDAL = new DAL.NGLLaneTranData(Parameters);
                bool blnRet = oDAL.SaveOrCreateLaneTran(data);
        ...
        public Models.Response DELETE(int id)
        {
            ...
            {
                DAL.NGLLaneTranData oDAL = new DAL.NGLLaneTranData(Parameters);
                bool blnRet = oDAL.DeleteLaneTran(id);
                bool[] oRecords = new bool[1];
                oRecords[0] = blnRet;
                response = new Models.Response(oRecords, 1);
            }
