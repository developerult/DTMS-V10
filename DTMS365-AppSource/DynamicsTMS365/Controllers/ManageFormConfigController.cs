...
{
    public class ManageFormConfigController : NGLControllerBase
    {
        #region " Constructors "

        /// <summary> Initializes the Page property by calling the base class constructor </summary>
        public ManageFormConfigController() : base(Utilities.PageEnum.ManageSecurity) { }
        ...
        private string _SourceClass = "DynamicsTMS365.Controllers.ManageFormConfigController";
        ...
        public Models.Response Post([FromBody]DModel.SecurityTypeConfig data)
        {
            ...
            try
            {                
                NGLSecurityData.ConfigureSecTypesForForm(data);
