...
{
    public class CompDetailController : NGLControllerBase
    {
        #region " Constructors "

        /// <summary>Initializes the Page property by calling the base class constructor</summary>
        public CompDetailController() : base(Utilities.PageEnum.CompanyDetail) { }
        ...
        private string _SourceClass = "DynamicsTMS365.Controllers.CompDetailController";
        ...
        public Models.Response Get(int id)
        {
            ...
            //The system looks up the last saved CompDetail pk for this user and return the first Comp record found
