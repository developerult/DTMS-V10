...
{
    public class LoadBoardCarrierDataController : NGLControllerBase
    {

        #region " Constructors "

        /// <summary>Initializes the Page property by calling the base class constructor</summary>
        public LoadBoardCarrierDataController() : base(Utilities.PageEnum.LoadBoardCarrierData) { }
        ...
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardCarrierDataController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                Models.BookCarrier[] records = new Models.BookCarrier[1];
                if (id == 0) {
                ...
                DTO.BookCarrier oData = NGLBookCarrierData.GetBookCarrierFiltered(id);
                if (oData != null) { 
                    records[0] = Models.BookCarrier.selectModelData( oData); 
                }
        ...
        public Models.Response Post([FromBody]Models.BookCarrier data)
        {
            var response = new Models.Response(); //new HttpResponseMessage();
            if (!authenticateController(ref response)) { return response; }
            try
            {
                NGLBookCarrierData.UpdateRecord(Models.BookCarrier.selectDTOData(data));
                bool[] results = new bool[1] { true };
