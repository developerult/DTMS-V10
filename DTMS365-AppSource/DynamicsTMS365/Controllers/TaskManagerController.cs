...
{
    public class TaskManagerController : NGLControllerBase
    {
        #region " Constructors "

        public TaskManagerController()
            : base(Utilities.PageEnum.TaskManager)
        {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.TaskManagerController";
