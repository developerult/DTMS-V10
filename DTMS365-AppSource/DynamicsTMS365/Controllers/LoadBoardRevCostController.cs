...
{
    public class LoadBoardRevCostsController : NGLControllerBase
    {
        ...
        /// </summary>
        public LoadBoardRevCostsController()
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardRevCostsController";
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                oData = oDAL.GetLoadBoardRevCosts(id);
                count = oData.Count();
