...
namespace DynamicsTMS365.Controllers
{
    public class RateShoppingController : NGLControllerBase
    {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.RateShoppingController";
