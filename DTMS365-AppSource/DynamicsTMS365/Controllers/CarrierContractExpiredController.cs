...
{
    public class CarrierContractExpiredController : NGLControllerBase
    {

        #region " Constructors "

        public CarrierContractExpiredController()
            : base(Utilities.PageEnum.CarrierQualification)
        {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.CarrierContractExpiredController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                records = oDAL.GetCarrierContractExpiredAlerts365(f, ref RecordCount);                
