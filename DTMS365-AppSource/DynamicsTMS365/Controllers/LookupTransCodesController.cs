...
namespace DynamicsTMS365.Controllers
{
    public class LookupTransCodesController : NGLControllerBase
    {
        ...
        private Models.Codes selectModelData(LTS.Code d)
        {
            ...
            if (d != null)
            {
                List<string> skipObjs = new List<string> { "CodeUpdated", "rowguid" };
                string sMsg = "";
        ...
        private Models.Codes selectLTSData(LTS.vLookupTranCode d)
        {
            Models.Codes modelRecord = new Models.Codes();
            if (d != null)
            {
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
               ...
               // f.ParentControl = readPagePrimaryKey(Parameters, Utilities.PageEnum.StaticListMaint);
                ...
                LTS.vLookupTranCode[] oData = new LTS.vLookupTranCode[] { };
                oData = oDAL.GetTranCodesFiltered(f, ref RecordCount, CodeType);
