...
{
    public class WorkflowConfigurationController : NGLControllerBase
    {
        #region " Constructors "

        public WorkflowConfigurationController()
            : base(Utilities.PageEnum.WorkflowConfiguration)
        {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.WorkflowConfigurationController";
