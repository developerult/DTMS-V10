...
namespace DynamicsTMS365.Controllers
{
    ...
    public class LoadBoardRevChargesController : NGLControllerBase
    {
        ...
        /// </summary>
        public LoadBoardRevChargesController()
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardRevChargesController";
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                //if (!string.IsNullOrWhiteSpace(filter)) { savePageFilters(filter, "LBRevChargesFilter"); }
                ...
                oData = oDAL.GetLoadBoardRevCharges(id);
                count = oData.Count();
