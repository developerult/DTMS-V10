...
{
    public class TariffRateFlatController : NGLControllerBase
    {
        ...
        /// </summary>
        public TariffRateFlatController()
                : base(Utilities.PageEnum.TariffRatesFlat)
	     {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.TariffRateFlatController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                oData = oDAL.GetCarrTarEquipMatFlatRates(f, ref RecordCount);
                if (oData == null)
                {
        ...
        public Models.Response Post([System.Web.Http.FromBody]LTS.vCarrTarEquipMatPivotTruckLoad data)
        {
            ...
            {
                DAL.NGLCarrTarEquipMatData oDAL = new DAL.NGLCarrTarEquipMatData(Parameters);
                bool blnRet = oDAL.SaveCarrTarEquipMatFlatRate(data);
