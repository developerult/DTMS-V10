...
{
    public class BookRevFeesController  : NGLControllerBase
    {
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.BookRevFeesController";
        ...
        // Read only list get returns nothing
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                DTO.BookRevFee[] fees = new DTO.BookRevFee[] { }; 
                int iBookControl = 0;
                ...
                int count = 0;
                fees = oBookDAL.GetBookRevFees(iBookControl);
        ...
        public Models.Response Post([System.Web.Http.FromBody] LTS.vBookFee data)
        {
            //create a response message to send back
            var response = new Models.Response(); //new HttpResponseMessage();
            if (!authenticateController(ref response)) { return response; }
            try
            {               
                // Read only list Post returns false
        ...
        public Models.Response DELETE(int id)
        {
            ...
            try
            {
                // Read only list Delete returns false
                bool[] oRecords = new bool[1];
                oRecords[0] = false;
                response = new Models.Response(oRecords, 1);
            }
