...
{
    public class SchedulerController : NGLControllerBase
    {
        #region " Constructors "
        /// <summary>
        ...
        public SchedulerController()
                : base(Utilities.PageEnum.Scheduler)
	     {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.SchedulerController";
