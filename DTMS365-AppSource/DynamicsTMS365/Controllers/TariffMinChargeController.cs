...
{
    public class TariffMinChargeController : NGLControllerBase
    {
        ...
        /// </summary>
        public TariffMinChargeController()
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.TariffMinChargeController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                if (id != 0)
                {
                    f.filterName = "CarrTarMinChargeControl";
                    f.filterValue = id.ToString();
                }
                //get the parent control
                f.ParentControl = readPagePrimaryKey(Parameters, Utilities.PageEnum.Tariff);
                DAL.NGLCarrTarMinChargeData oDAL = new DAL.NGLCarrTarMinChargeData(Parameters);
                LTS.vCarrierTariffMinCharge[] oData = new LTS.vCarrierTariffMinCharge[] { };
                oData = oDAL.GetCarrierTariffMinCharges(f, ref RecordCount);
                count = oData.Count();
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(filter)) { savePageFilters(filter, "TariffMInChargeFilte"); }
                f.ParentControl = readPagePrimaryKey(Parameters, Utilities.PageEnum.Tariff);
        ...
        public Models.Response Post([System.Web.Http.FromBody]LTS.vCarrierTariffMinCharge data)
        {
            ...
            {
                DAL.NGLCarrTarMinChargeData oDAL = new DAL.NGLCarrTarMinChargeData(Parameters);
                bool blnRet = oDAL.SaveCarrierTariffMinCharge(data);
        ...
        public Models.Response DELETE(int id)
        {
            ...
            {
                DAL.NGLCarrTarMinChargeData oDAL = new DAL.NGLCarrTarMinChargeData(Parameters);
                bool blnRet = oDAL.DeleteCarrierTariffMinCharge(id);
                bool[] oRecords = new bool[1];
                oRecords[0] = blnRet;
                response = new Models.Response(oRecords, 1);
            }
