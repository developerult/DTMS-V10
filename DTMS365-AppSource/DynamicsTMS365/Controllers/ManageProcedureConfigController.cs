...
{
    public class ManageProcedureConfigController : NGLControllerBase
    {
        #region " Constructors "

        /// <summary> Initializes the Page property by calling the base class constructor </summary>
        public ManageProcedureConfigController() : base(Utilities.PageEnum.ManageSecurity) { }
        ...
        private string _SourceClass = "DynamicsTMS365.Controllers.ManageProcedureConfigController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                oData = NGLSecurityData.GetProcedureSecTypeXTabData(ref RecordCount, f);
                if (oData?.Count() > 0)
                {
                    count = oData.Count();
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                if (!string.IsNullOrWhiteSpace(filter)) { savePageFilters(filter, "ProcConfigGridFltr"); } //save the page filter for the next time the page loads
        ...
        public Models.Response Post([FromBody]DModel.SecurityTypeConfig data)
        {
            ...
            try
            {
                NGLSecurityData.ConfigureSecTypesForProcedure(data);
