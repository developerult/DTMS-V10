...
{
    public class ManageScheduleController : NGLControllerBase
    {
        #region " Constructors "
        /// <summary>
        ...
        public ManageScheduleController()
                : base(Utilities.PageEnum.ManageSchedule)
	     {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.ManageScheduleController";
