...
{
    public class CarrierExposureShipmentController : NGLControllerBase
    {
        #region " Constructors "

        public CarrierExposureShipmentController()
            : base(Utilities.PageEnum.CarrierExposureShipment)
        {
        }
        ...
        /// </summary>
        private string _SourceClass = "DynamicsTMS365.Controllers.CarrierExposureShipmentController";
        ...
        public Models.Response Get(int id)
        {
            ...
            try
            {
                ...
                records = oDAL.GetCarrierInsExpPerShipAlerts365(f, ref RecordCount);
