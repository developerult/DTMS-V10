...
{
    public class LoadBoardRevLoadCostsController : NGLControllerBase
    {

        #region " Constructors "

        /// <summary>Initializes the Page property by calling the base class constructor</summary>
        public LoadBoardRevLoadCostsController() : base(Utilities.PageEnum.LoadBoardRevenueLoad) { }
        ...
        private string _SourceClass = "DynamicsTMS365.Controllers.LoadBoardRevLoadCostsController";
        ...
        public Models.Response GetAllRecords(string filter)
        {
            ...
            try
            {
                ...
                //if (!string.IsNullOrWhiteSpace(filter)) { savePageFilters(filter, "LBRevLdCostFltr"); } //save the page filter for the next time the page loads
                ...
                oData = oDAL.GetLoadBoardRevLoadCosts(iBookControl);
                count = oData.Count();
