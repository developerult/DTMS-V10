...
{
    public partial class Contact : NGLWebUIBaseClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.Contact;
                refreshUserControl();
                ...
                //The Contact page is the same for everyone and is always visible
