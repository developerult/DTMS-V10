...
{
    public partial class LoadBoardLoadStatus : NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.LoadBoardLoadStatus;
                refreshUserControl();
                    ...
                    else
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(sParent))
                    {
                        ...
                        sRedirect = WebBaseURI + "LoadBoardLoadStatus?parent=" + sParent;
                    }
                    else
                    {
