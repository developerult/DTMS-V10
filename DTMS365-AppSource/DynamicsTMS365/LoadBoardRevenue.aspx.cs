...
{
    public partial class LoadBoardRevenue : NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.LoadBoardRevenue;
                refreshUserControl();
                ...
                else
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(sParent))
                    {
                        ...
                        sRedirect = WebBaseURI + "LoadBoardRevenue?parent=" + sParent;
                    }
                    else
                    {
