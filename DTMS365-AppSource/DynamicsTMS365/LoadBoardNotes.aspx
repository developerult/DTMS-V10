<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadBoardNotes.aspx.cs" Inherits="DynamicsTMS365.LoadBoardNotes" %>

<!DOCTYPE html>

<html>
<head>
    <title>DTMS Load Board Notes</title>        
         <%=cssReference%>             
        <style>
            html,
     ...
     <script>
        ...
        <% Response.Write(NGLOAuth2); %>
         ...
         function execActionClick(btn, proc){
             ...
             else { ngl.pgNavigation(btn.id, true, BookControlKey); }// modified by RHR for v-8.5.4.004 on 12/07/2023  added page navigation menu method
         }

         function refresh(){ 
             if (wdgtBookNoteDataEdit) { wdgtBookNoteDataEdit.read(0); } 
         }
