<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadBoardFinancial.aspx.cs" Inherits="DynamicsTMS365.LoadBoardFinancial" %>

<!DOCTYPE html>

<html>
<head>
    <title>DTMS Load Board Financial</title>        
         <%=cssReference%>             
        <style>
            html,
    ...
    <% Response.WriteFile("~/Views/HelpWindow.html"); %>   
     ...
     <script>
         // created by RHR for v-8.5.2.006 on 12/22/2022 added page navigation menu method
        ...
        <% Response.Write(NGLOAuth2); %>
         ...
         function refresh() {
             ...
             if (wdgtLoadBoardFinancialEdit) {  wdgtLoadBoardFinancialEdit.read(0); }
         }

        
         //*************  Call Back Functions ****************

         function LoadBoardFinancialDataCB(oResults) {
             //Modified by RHR for v-8.5.4.004 on 12/06/2023 new Key table properties
