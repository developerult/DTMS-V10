...
{
    public partial class TariffRatesMatrix :  NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            refreshUserControl();
            DynamicsTMS365.Controllers.TariffRateDistanceController oTR = new DynamicsTMS365.Controllers.TariffRateDistanceController();
            oTR.UserControl = this.UserControl;
            PageControl = oTR.GetPageControlForActiveTariff();
