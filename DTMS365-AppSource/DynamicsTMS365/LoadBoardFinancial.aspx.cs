...
{
    /// <summary>
    /// Code Behind for Load Board Financial Data
    /// </summary>
    /// <remarks>
    ///  created by RHR for v-8.5.2.006 on 12/22/2022 added booking financial data
    /// </remarks>
    public partial class LoadBoardFinancial : NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                PageControl = (int)Utilities.PageEnum.LoadBoardFinancial;
                refreshUserControl();
                ...
                else
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(sParent))
                    {
                        ...
                        sRedirect = WebBaseURI + "LoadBoardFinancial?parent=" + sParent;
                    }
                    else
                    {
