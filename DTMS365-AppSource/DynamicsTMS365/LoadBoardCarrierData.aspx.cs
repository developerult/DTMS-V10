...
{
    public partial class LoadBoardCarrierData : NGLWebUIBaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.LoadBoardCarrierData;
                refreshUserControl();
                ...
                } else
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(sParent))
                    {
                        ...
                        sRedirect = WebBaseURI + "LoadBoardCarrierData?parent=" + sParent;
                    }
                    else
                    {
