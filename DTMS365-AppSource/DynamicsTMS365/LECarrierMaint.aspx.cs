...
{
    public partial class LECarrierMaint : NGLWebUIBaseClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                PageControl = (int)Utilities.PageEnum.LegalEntityCarrierMaint;
                refreshUserControl();
                ...
                if (request.QueryString.GetValues("carrControl") != null && request.QueryString.GetValues("carrControl").Length != 0)
                {
                    pg.addToDictOverrideSavedFilterArray("LECarSetFilter", "CarrierControl", request.QueryString.GetValues("carrControl")[0]);
