<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EDIDocStructLoops.aspx.cs" Inherits="DynamicsTMS365.EDIDocStructLoops" %>

<!DOCTYPE html>

<html>
<head>
    <title>EDITP DocStruct Loops</title>         
...
<script>kendo.ui['Button'].fn.options['size'] = "small";</script>
    ...
    <div id="example" class="ui-container">
            ...
            <div id="top-pane">
                <div id="horizontal" class="ui-horizontal-container">
                    ...
                    <div id="center-pane">
                        ...
                        <div id="window">
                              <textarea id="editor" rows="10" cols="30" style="height:440px" aria-label="editor" data-bind="value: DSAttrNotes"></textarea>
                         </div>
                        <!-- End Page Content -->
                    </div>
                </div>
        ...
        <%--Added By SRP on 2/22/2018 KendoWindow for DocStructLoopsAddWindow--%>
        <% Response.WriteFile("~/Views/DocStructLoopsAddWindow.html"); %>
        <%--Added By SRP on 2/22/2018 KendoWindow for PreviewDocStructure--%>
        <% Response.WriteFile("~/Views/PreviewDocStructure.html"); %>
        <%--Added By SRP on 2/22/2018 EDIStructLoop for KendoWindow--%>
        <% Response.WriteFile("~/Views/EDIDocStructLoopAddWindow.html"); %>
        ...
        <script>
            ...
            var EDITName = getParameterByName('EDITName');
            var TPDocInOutbound;
            if(getParameterByName('TPDocInOutbound')== "true")
            {
                TPDocInOutbound="InBound";
            }
            else
            {
                TPDocInOutbound="OutBound";
            }
            var CompName = getParameterByName('CompName');

            var CarrierName = getParameterByName('CarrierName');
           ...
           // $("#show").append(header);
            ...
            function openMasterDocEditWindow(e) {
                ...
                $("#txtMDSLoopControl").val(eitem.DSLoopControl);
                
                var ddl= $("#ddlMDSLoopLoopControl").data("kendoDropDownList");
                ddl.value(parseInt(eitem.DSLoopLoopControl));
                ddl.enable(false);

                $("#ddlMDSLoopParentLoopID").data("kendoDropDownList").value(parseInt(eitem.DSLoopParentLoopID));
           
                var usage = eitem.DSLoopUsage
                $("#ddlMDSLoopUsage").data("kendoDropDownList").value(usage);

                $("#txtMDSLoopMinCount").data("kendoMaskedTextBox").value(eitem.DSLoopMinCount);

                $("#txtMDSLoopMaxCount").data("kendoMaskedTextBox").value(eitem.DSLoopMaxCount);

                $("#txtMDSLoopSeqIndex").data("kendoMaskedTextBox").value(eitem.DSLoopSeqIndex);

                $("#txtMDSLoopModDate").val(eitem.DSLoopModDate);
                $("#txtMDSLoopModUser").val(eitem.DSLoopModUser);
                $("#txtMDSLoopUpdated").val(eitem.DSLoopUpdated);
                $("#txtMDSLoopCreateDate").val(eitem.DSLoopCreateDate);
                $("#txtMDSLoopCreateUser").val(eitem.DSLoopCreateUser);

                $("#chkMDSLoopDisabled").prop('checked', eitem.DSLoopDisabled);
            ...
            function SaveEDIMasterDoc() {
                ...
                item.DSLoopControl = $("#txtMDSLoopControl").val();
                if (item.DSLoopControl == 0){
                    item.DSLoopControl = $("#txtMDSLoopControl").val();

                    item.DSLoopTPDocControl = TPDocControl;

                    var dataItem1 = $("#ddlMDSLoopLoopControl").data("kendoDropDownList").dataItem();
                    item.DSLoopLoopControl  = dataItem1.LoopControl;

                    var dataItem2 = $("#ddlMDSLoopParentLoopID").data("kendoDropDownList").dataItem();
                    item.DSLoopParentLoopID  = dataItem2.LoopControl;

                    var dataItem3 = $("#ddlMDSLoopUsage").data("kendoDropDownList").dataItem();
                    item.DSLoopUsage  = dataItem3.UsControl;

                    item.DSLoopMinCount = $("#txtMDSLoopMinCount").data("kendoMaskedTextBox").value();

                    item.DSLoopMaxCount = $("#txtMDSLoopMaxCount").data("kendoMaskedTextBox").value();

                    item.DSLoopSeqIndex = $("#txtMDSLoopSeqIndex").data("kendoMaskedTextBox").value();

                    item.DSLoopDisabled= $("#chkMDSLoopDisabled").is(":checked");
                    ...
                    if (submit == true) {
                        ...
                        $.ajax({
                            async: false,
                            type: "POST",
                            url: "api/EDIDocStructLoop/SaveMDocSegmentElementMap/",
                            contentType: "application/json; charset=utf-8",
                            dataType: 'json',
                    ...
                    item.DSLoopModUser = $("#txtMDSLoopModUser").val();
                    item.DSLoopUpdated = $("#txtMDSLoopUpdated").val();
                    item.DSLoopModDate = $("#txtMDSLoopModDate").val();
                    item.DSLoopCreateDate = $("#txtMDSLoopCreateDate").val();
                    item.DSLoopCreateUser = $("#txtMDSLoopCreateUser").val();
                    ...
                    if (submit == true) {
                        ...
                        $.ajax({
                            async: false,
                            type: "POST",
                            url: "api/EDIDocStructLoop/UpdateEDIDocStructLoop",
                            contentType: "application/json; charset=utf-8",
                            dataType: 'json',
                            data: JSON.stringify(item),
                            headers: { "Authorization": localStorage.NGLvar1454, "USC": localStorage.NGLvar1452 },
            ...
            //For Adding Elements and Attribute and Segments 
            $("#btnAddElememts").click(function(){
                ...
                var DSSegMDSLoopControl = $("#txtMDSSegMDSLoopControl").val();
                ...
                var dataJSON = { SegmentControl: SegmentControl,segmentlength:segmentlength,MDSSegMDSLoopControl:DSSegMDSLoopControl };
            
                if(submit == true){
                    $.ajax({
                        async: false,
                        type: "POST",
                        url: "api/EDIDocStructSegment/SaveDocStructLoopSegmentElement",
                        contentType: "application/json; charset=utf-8",
                        dataType: 'json',
                        ...
                        success: function (data) {
                            try {
                                ...
                                if (typeof (data) !== 'undefined' && ngl.isObject(data)) {
                                    if (typeof (data.Errors) !== 'undefined' && data.Errors != null && data.Errors.length > 0) {
                                        blnErrorShown = true;
                                        ngl.showErrMsg("Add EDITP DOCSegmentlememts Failure", data.Errors, null);
                                    }
                                    else {
                                        if (typeof (data.Data) !== 'undefined' && ngl.isArray(data.Data)) {
                                            if (data.Data.length > 0 && typeof (data.Data[0]) !== 'undefined') {
                                ...
                                if (blnSuccess === false && blnErrorShown === false) {
                                    if (strValidationMsg.length < 1) { strValidationMsg = "Add EDITP DOCSegmentlememts Failure"; }
                                    ngl.showErrMsg("Add EDITP DOCSegmentlememts Failure", strValidationMsg, null);
                                }
                            } catch (err) {
                                ngl.showErrMsg(err.name, err.description, null);
                            }
                        ...
                        error: function (xhr, textStatus, error) {
                            var sMsg = formatAjaxJSONResponsMsgs(xhr, textStatus, error, "Add EDITP DOCSegmentlememts Failure");
                            ngl.showErrMsg("Add EDITP DOCSegmentlememts Failure", sMsg, null);
                        }
                    });
                }
            ...
            //Edit Window for MasterDocStructLoop
            function openMasterDocStructLoopEditWindow(e) {
                ...
                //*****Title of Window
                $("#wndAddMasterDocStructLoop").data("kendoWindow").title("Edit EDITP Doc Struct Loop Details");
                ...
                loopControl = item.DSLoopControl;

                var ddl= $("#lblMDSLoopLoopControl").data("kendoDropDownList");
                ddl.value(parseInt(item.DSLoopLoopControl));
                ddl.wrapper.hide();
                var lName = $("#lblMDSLoopLoopControl").data("kendoDropDownList").text();
                $("#LoopName").text(lName);

                $("#txtMDSSegMDSLoopControl").val(item.DSLoopControl);
                ...
                //**********Segment  Grid ReCreate with fresh******//
                ...
                dsMDocSegmentsByLoop = new kendo.data.DataSource({
                    transport: {
                        read: function(options) { 
                            $.ajax({ 
                                url: 'api/EDIDocStructSegment/GetRecordSegmentByLoop', 
                                contentType: 'application/json; charset=utf-8', 
                                dataType: 'json', 
                        ...
                        destroy: function(options) {
                            ...
                            var Segcontrol = { DSSegControl : options.data.DSSegControl }
                            $.ajax({
                                url: 'api/EDIDocStructSegment/DeleteRecord', 
                                type: 'POST',
                                contentType: 'application/json; charset=utf-8', 
                                dataType: 'json', 
                                ...
                                success: function (data) {     
                                    try {                                    
                                        ...
                                        if(typeof (data) !== 'undefined' && ngl.isObject(data)){
                                            ...
                                            if (typeof (data.Errors) !== 'undefined' && data.Errors != null && data.Errors.length > 0) {
                                                blnErrorShown = true;
                                                ngl.showWarningMsg("Segments cannot be deleted!", data.Errors, null);
                                            }
                                        }
                                ...
                                error: function (xhr, textStatus, error) {
                                    var sMsg = formatAjaxJSONResponsMsgs(xhr, textStatus, error, "delete Segments Failure");
                                    ngl.showErrMsg("delete Segments Failure", sMsg, null); 
                                } 
                            });
                        },
                    ...
                    error: function(xhr, textStatus, error) {
                        ngl.showErrMsg("Access SegElement Data Failed", formatAjaxJSONResponsMsgs(xhr, textStatus, error, " cannot complete your request"), null); this.cancelChanges();
                    }
                });
                ...
                $("#listBox").kendoGrid({
                    ...
                    editable:"inline",
                    columns: [
                        { field: "DSSegControl", title: "DSSegControl", hidden: true },
            ...
            function SaveEDIMasterDocSegment() {
                ...
                var otmp = $("#focusCancel").focus();
                var submit = true;
                var SegmentNew = $("#ddlSegmentType").val();
                if (SegmentNew =="") {
                    $("#segment-validation").removeClass("hide-display");
                    submit = false;
                }
                ...
                if(SegDetailes.Data.length > 0){
                    item.DSSegControl  = SegDetailes.Data[0].DSSegControl;
                    item.DSSegDSLoopControl  = SegDetailes.Data[0].DSSegDSLoopControl;
                    item.DSSegSegmentControl  = SegDetailes.Data[0].DSSegSegmentControl;

                    var dataItem2 = $("#ddlSegUsage").data("kendoDropDownList").dataItem();
                    item.DSSegUsage  = dataItem2.UsControl;

                    item.DSSegMinCount = $("#txtSegmentMinCount").data("kendoMaskedTextBox").value();

                    item.DSSegMaxCount = $("#txtSegmentMaxCount").data("kendoMaskedTextBox").value();

                    item.DSSegDesc= $("#txtSegmentDesc").data("kendoMaskedTextBox").value();

                    item.DSSegSeqIndex =  $("#txtSegmentSeqIndex").data("kendoMaskedTextBox").value();

                    item.DSSegDisabled  = SegDetailes.Data[0].DSSegDisabled;
                    item.DSSegCreateDate  = SegDetailes.Data[0].DSSegCreateDate;
                    item.DSSegCreateUser  = SegDetailes.Data[0].DSSegCreateUser;
                    item.DSSegModDate  = SegDetailes.Data[0].DSSegModDate;
                    item.DSSegModUser  = SegDetailes.Data[0].DSSegModUser;
                    item.DSSegUpdated  = SegDetailes.Data[0].DSSegUpdated;
                
                    if (submit == true) {
                        $.ajax({
                            async: false,
                            type: "POST",
                            url: "api/EDIDocStructSegment/UpdateEDIDocStructSegment",
                            data: JSON.stringify(item),
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'json',
                            headers: { "Authorization": localStorage.NGLvar1454, "USC": localStorage.NGLvar1452 },
                            success: function (data) {
                                try {
                                    ...
                                    if (data.Data.length > 0 && typeof (data.Data[0]) !== 'undefined') {
                                        ...
                                        segmentDetailsFill(data.Data[0].DSSegSegmentControl);
                                    }
                                    if (blnSuccess === false && blnErrorShown === false) {
                    ...
                    item.DSSegControl = $("#txtMDSSegControl").val();

                    item.DSSegDSLoopControl=$("#txtMDSSegMDSLoopControl").val();
            
                    var dataItem1 = $("#ddlSegmentType").data("kendoDropDownList").dataItem();
                    item.DSSegSegmentControl  = dataItem1.SegmentControl;
                    ...
                    if (submit == true) {
                        $.ajax({
                            async: false,
                            type: "POST",
                            url: "api/EDIDocStructSegment/SaveEDIDocStructSegment",
                            data: JSON.stringify(item),
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'json',
                            headers: { "Authorization": localStorage.NGLvar1454, "USC": localStorage.NGLvar1452 },
            ...
            function segmentDetailsFill(segmentControl){
                //************* Segmemt Data *************//
                $.ajax({ 
                    url: 'api/EDIDocStructSegment/GetSegmentRecordsbySegmentLoop', 
                    contentType: 'application/json; charset=utf-8', 
                    dataType: 'json', 
                    async: false,
                ...
                if(SegDetailes.Data.length > 0){
                    ...
                    var usage = SegDetailes.Data[0].DSSegUsage
                    $("#ddlSegUsage").data("kendoDropDownList").value(usage);

                    $("#txtSegmentMinCount").data("kendoMaskedTextBox").value(SegDetailes.Data[0].DSSegMinCount);
                    $("#txtSegmentMaxCount").data("kendoMaskedTextBox").value(SegDetailes.Data[0].DSSegMaxCount);
                    $("#txtSegmentDesc").data("kendoMaskedTextBox").value(SegDetailes.Data[0].DSSegDesc);
                    $("#txtSegmentSeqIndex").data("kendoMaskedTextBox").value(SegDetailes.Data[0].DSSegSeqIndex);
                }
                else{
            ...
            function ElemntsAndAttributes(segment){
                ...
                SegElementGridDataSource = new kendo.data.DataSource({
                    ...
                    transport: {
                        read: function(options) { 
                            $.ajax({ 
                                url: 'api/EDIDocStructSegment/GetRecordSegmentLoopElement', 
                                contentType: 'application/json; charset=utf-8', 
                                dataType: 'json', 
                                ...
                                success: function(data) {
                                    ...
                                    try {                                    
                                        ...
                                        if (typeof (data) !== 'undefined' && ngl.isObject(data)) {
                                            if (typeof (data.Errors) !== 'undefined' && data.Errors != null && data.Errors.length > 0) {
                                                blnErrorShown = true;
                                                ngl.showErrMsg("Get Segment Elemnts Failure", data.Errors, null);
                                            }
                                            else {
                                                if (typeof (data.Data) !== 'undefined' && ngl.isArray(data.Data)) {
                                                    if (data.Data.length > 0 && typeof (data.Data[0]) !== 'undefined' && ngl.isObject(data.Data[0])) {
                                        ...
                                        if (blnSuccess === false && blnErrorShown === false) {
                                            if (strValidationMsg.length < 1) { strValidationMsg = "Get Segment Elemnts Failure"; }
                                            ngl.showErrMsg("Get Segment Elemnts Failure", strValidationMsg, null);
                                        }
                                    } catch (err) {
                                        ngl.showErrMsg(err.name, err.description, null);
                                    }
                                ...
                                error: function (xhr, textStatus, error) {
                                    var sMsg = formatAjaxJSONResponsMsgs(xhr, textStatus, error, "Get Segment Elemnts Failure");
                                    ngl.showErrMsg("Get Segment Elemnts Failure", sMsg, null); 
                        ...
                        update: function(options) {
                            $.ajax({ 
                                url: 'api/EDIDocStructElement/UpdateEDIDocStructElement', 
                                type: "POST",
                                contentType: 'application/json; charset=utf-8', 
                                dataType: 'json', 
                                ...
                                success: function (data) {     
                                    try {         
                                        ...
                                        if (blnSuccess === false && blnErrorShown === false) {
                                            ...
                                            ngl.showErrMsg("Update SegElement Failure", strValidationMsg, null);
                                        }
                                    } catch (err) {
                                        ngl.showErrMsg(err.name, err.description, null);
                                    }
                                ...
                                error: function (xhr, textStatus, error) {
                                    ...
                                    ngl.showErrMsg("Update Segment Element Failure1", sMsg, null); 
                                } 
                            });
                        },
                        destroy: function(options) {
                            var EleControl = { DSElementControl : options.data.DSElementControl }
                            $.ajax({
                                url: 'api/EDIDocStructElement/DeleteRecord', 
                                type: 'POST',
                                contentType: 'application/json; charset=utf-8', 
                                dataType: 'json', 
                    ...
                    schema: {
                        ...
                        model: {
                            id: "DSElementControl",
                            fields: {
                                DSElementControl: { type: "number" },
                                DSElementName: { type: "string", editable: false },
                                DSElementDesc: { type: "string" },
                                DSElementMinCount: { type: "number" },
                                DSElementMaxCount: { type: "number" },
                                DSElementDisabled: { type: "boolen" },
                            }
                        },
                        errors: "Errors"
                    },
                    error: function(xhr, textStatus, error) {
                        ngl.showErrMsg("Access Segment Element Data Failed", formatAjaxJSONResponsMsgs(xhr, textStatus, error, " cannot complete your request"), null); this.cancelChanges();
                    }
                });
                ...
                $("#SegElementsGrid").kendoGrid({
                    ...
                    columns: [
                        { field: "DSElementControl", title: "DSElementControl", hidden: true },
                        { field: "DSElementName", title: "Element Name", hidden: false },
                        { field: "DSElementDesc", title: "Element Desc", hidden: false },
                        { field: "DSElementEDIDataTypeControl", title: "Element Data Type", hidden: false,  editor: editDocType, template:data=>dsDataTypeDropDown._data[Object.values(dsDataTypeDropDown._data).findIndex(x=> x.Control == data.DSElementEDIDataTypeControl)].Name}, 
                        { field: "DSElementUsage", title: "Element Usage", hidden: false,  editor: editUsageDropDown, template:data=>ddlUsage[Object.values(ddlUsage).findIndex(x=> x.UsControl == data.DSElementUsage)].UsName},
                        { field: "DSElementMinCount", title: "MinLength", hidden: false },
                        { field: "DSElementMaxCount", title: "MaxLength", hidden: false },
                        { command: [{ name: "edit", text:{edit: "", update: "", cancel: ""}},{ name: "destroy", text:"",   imageClass: "k-i-delete", iconClass: "k-icon",  visible: function(dataItem){ var elength = SegElementGridDataSource._data.length; return dataItem.DSElementName == SegElementGridDataSource._data[elength-1].DSElementName} }], title: "Action", width: "80px" }
                    ]
                });
          
                //************ Chaild Grid Attributes ******************//
                function detailInit(e) {
                    var TAttrID = e.data.DSElementControl;
                    window.AttrID =e.data.DSElementControl;
                    ...
                    AttrGridDataSource = new kendo.data.DataSource({
                        ...
                        transport:{
                            read: function(options) { 
                                $.ajax({ 
                                    url: 'api/EDIDocStructElmntAttribute/GetRecordsbyElementId', 
                                    contentType: 'application/json; charset=utf-8', 
                                    datatype: 'json',
                            ...
                            create: function(options) {
                                ...
                                options.data.DSAttrDSElementControl = modelnew.DSElementControl;
                                window.AttrID = modelnew.DSElementControl;
                                $.ajax({ 
                                    url: 'api/EDIDocStructElmntAttribute/SaveEDIDocStructElmntAttribute', 
                                    type: "POST",
                                    contentType: 'application/json; charset=utf-8', 
                                    dataType: 'json', 
                                    data: JSON.stringify(options.data),
                            ...
                            update: function(options) {
                                window.AttrID=options.data.DSAttrDSElementControl;
                                $.ajax({ 
                                    url: 'api/EDIDocStructElmntAttribute/UpdateEDIDocStructElmntAttribute', 
                                    type: "POST",
                                    contentType: 'application/json; charset=utf-8', 
                                    dataType: 'json', 
                                    data: JSON.stringify(options.data),
                                    ...
                                    success: function (data) {     
                                        try {         
                                            ...
                                            if (typeof (data) !== 'undefined' && ngl.isObject(data)) {
                                                if (typeof (data.Errors) !== 'undefined' && data.Errors != null && data.Errors.length > 0) {
                                                    blnErrorShown = true;
                                                    ngl.showErrMsg("Update Element Attributes Failure", data.Errors, null);
                                                }
                                                else {
                                                    if (typeof (data.Data) !== 'undefined' && ngl.isArray(data.Data)) {
                                                        if (data.Data.length > 0 && typeof (data.Data[0]) !== 'undefined' && ngl.isObject(data.Data[0])) {
                                            ...
                                            if (blnSuccess === false && blnErrorShown === false) {
                                                if (strValidationMsg.length < 1) { strValidationMsg = "Update Element Attributes Failure"; }
                                                ngl.showErrMsg("Update Element Attributes Failure", strValidationMsg, null);
                                            }
                                        } catch (err) {
                                            ngl.showErrMsg(err.name, err.description, null);
                                        }
                                    ...
                                    error: function (xhr, textStatus, error) {
                                        var sMsg = formatAjaxJSONResponsMsgs(xhr, textStatus, error, "Update Element Attributes Failure");
                                        ngl.showErrMsg("Update Element Attributes Failure1", sMsg, null); 
                                    } 
                                });
                            },
                            destroy: function(options) {
                                window.AttrID=options.data.DSAttrDSElementControl;
                                var EleAttribControl = { DSAttrControl : options.data.DSAttrControl};
                                $.ajax({
                                    url: 'api/EDIDocStructElmntAttribute/DeleteRecord', 
                                    type: 'POST',
                                    contentType: 'application/json; charset=utf-8', 
                                    dataType: 'json', 
                                    ...
                                    try {
                                            ...
                                            var strValidationMsg = "";
                                            if (data == false) {
                                                ngl.showWarningMsg("Element Attributes cannot be deleted!", "", null);
                                            }
                                            if(typeof (data) !== 'undefined' && ngl.isObject(data)){
                                        
                                                if (typeof (data.Errors) !== 'undefined' && data.Errors != null && data.Errors.length > 0) {
                                                    blnErrorShown = true;
                                                    ngl.showWarningMsg("Element Attributes cannot be deleted!", data.Errors, null);
                                                }
                                            }
                                    ...
                                    error: function (xhr, textStatus, error) {
                                        var sMsg = formatAjaxJSONResponsMsgs(xhr, textStatus, error, "delete Element Attributes Failure");
                                        ngl.showErrMsg("delete Element Attributes Failure", sMsg, null); 
                                    } 
                                });
                            },
                            parameterMap: function (options, operation) { return options; }
                        ...
                        schema: {
                            ...
                            model: {
                                id: "DSAttrControl",
                                fields: {
                                    DSAttrControl: { type: "number" },
                                    DSAttrDSElementControl: { type: "number" },
                                    DSAttrQualifyingElementControl: { type: "number" },
                                    DSAttrQualifyingValue: { type: "string" },
                                    DSAttrDefaultVal:{ type: "string" },
                                    DSAttrNotes:{ type: "string" },
                                    DSAttrTransformationTypeControl: { type: "string" },
                                    DSAttrValidationTypeControl: { type: "string" },
                                    DSAttrFormattingFnControl: { type: "string" },
                                    DSAttrDataMapFieldControl:{ type: "string" },
                                    DSAttrDataMapFieldColumnControl:{ type: "string" },
                                }
                            },
                            errors: "Errors"
                        },
                    ...
                    $('<div id="grid'+e.data.DSElementControl+'" />').appendTo(e.detailCell).kendoGrid({
                        ...
                        editable: "inline",
                        columns: [
                            { field: "DSAttrControl", title:"DSAttrControl", hidden: true},
                            { field: "DSAttrDSElementControl", title:"DSAttrDSElementControl", hidden: true},
                            { field: "DSAttrQualifyingElementControl", title:"Qual Elmt Name",width:100, editor: QalyElmtNameDropDownEditor, hidden: false ,template:data=>{ var idx = Object.values(SegElementGridDataSource._data).findIndex(x => x.DSElementControl == data.DSAttrQualifyingElementControl); if(idx!= -1){return SegElementGridDataSource._data[idx].DSElementName}else{return "None"}}},
                            { field: "DSAttrQualifyingValue", title:"Qual Elmt Value" },
                            { field: "DSAttrDefaultVal", title:"Default Value" },
                            { field: "DSAttrNotes", title:"Notes", width: "50px", editor: editMDSAttrNotes, template:(x)=>'<span  class="k-icon k-i-search"></span>'},
                            { field: "DSAttrTransformationTypeControl", title:"Transformation", editor: TransformationDropDownEditor, hidden: false ,template:data=>{ var idx1 = Object.values(dsTransformationDropDown._data).findIndex(x => x.Control == data.DSAttrTransformationTypeControl); if(idx1!= -1){return dsTransformationDropDown._data[idx1].Name}else{return "None"}}},
                            { field: "DSAttrValidationTypeControl", title:"Validation", editor: ValidationDropDownEditor, hidden: false ,template:data=>{ var idx2 = Object.values(dsValidationDropDown._data).findIndex(x => x.Control == data.DSAttrValidationTypeControl); if(idx2!= -1){return dsValidationDropDown._data[idx2].Name}else{return "None"}}},
                            { field: "DSAttrFormattingFnControl", title:"FormatFn", editor: FormatingDropDownEditor, hidden: false ,template:data=>{ var idx3 = Object.values(dsFormatingDropDown._data).findIndex(x => x.Control == data.DSAttrFormattingFnControl); if(idx3!= -1){return dsFormatingDropDown._data[idx3].Name}else{return "None"}}},
                            { field: "DSAttrDataMapFieldColumnControl", title: "DataMap Tables", editor: DataMapFieldTableDropDownEditor,width:100, template:data=>{ var idx4 = Object.values(dsDataMapFieldColumn._data).findIndex(x => x.DataMapFieldControl == data.DSAttrDataMapFieldColumnControl); if(idx4!= -1){return dsDataMapFieldColumn._data[idx4].DataMapFieldTable;}else{return "None"}}},
                            { field: "DSAttrDataMapFieldControl", title:"DataMap  Columns", editor: DataMapFieldColumnDropDownEditor,width:150, template:data=>{ var idx5 = Object.values(dsDataMapFieldColumn._data).findIndex(x => x.DataMapFieldControl == data.DSAttrDataMapFieldControl); if(idx5!= -1){return dsDataMapFieldColumn._data[idx5].DataMapFieldColumn}else{return "None"}}},
                    ...
                    $('#grid'+TAttrID+'').kendoTooltip({
                        ...
                        content: function(e){
                            ...
                            var content = dataItem.DSAttrNotes;
                            return content;
                        },
                    });
                }
            ...
            //******** inlineEdit for Dropdowns and numbers ********//
            ...
            function FormatingDropDownEditor(container, options) {
                if(options.model.DSAttrFormattingFnControl==0){
                ...
                //$("#FormatingDropDownLists").data("kendoDropDownList").text(dsFormatingDropDown._data[0].Name);
            }

            function DataMapFieldTableDropDownEditor(container, options) {
                if(options.model.DSAttrDataMapFieldColumnControl==0){
                    ...
                    //$("#attriTableDropDownList").data("kendoDropDownList").text(dsDataMapFieldTable._data[0].DataMapFieldTable);
                }
                else
                {
                    var tableID = options.model.DSAttrDataMapFieldControl;
            ...
            function DataMapFieldColumnDropDownEditor(container, options) {
                ...
                $('<input id="attriColumnDropDownList" required data-text-field="DataMapFieldColumn" data-value-field="DataMapFieldControl" data-bind="value:' + options.field + '"/>')
                    ...
                    .kendoDropDownList({
                        ...
                        change: function (e) {
                            var fee = this.dataItem(e.item);
                            options.model.set("DataMapFieldControl", fee.ListTypeControl);
                            options.model.set("DataMapFieldColumn", fee.ListTypeName);
                        }
                    });
            ...
            function ValidationDropDownEditor(container, options) {
                if(options.model.DSAttrValidationTypeControl==0){
            ...
            function TransformationDropDownEditor(container, options) {
                if(options.model.DSAttrTransformationTypeControl==0){
               ...
               // $("#TransformationDropDownLists").data("kendoDropDownList").text(dsTransformationDropDown._data[0].Name);
            }
            ...
            function QalyElmtNameDropDownEditor(container, options) {
                ...
                if(options.model.DSAttrDSElementControl==0){
                    var newDS = SegElementGridDataSource._data;
                    var VeryNewDS =[{DSElementControl:'0',DSElementName:'None'}];
                    for(var i=0; i<newDS.length;i++){
                        if(newDS[i].DSElementControl == parentData.DSElementControl){

                        }else{
                            VeryNewDS.push(newDS[i])
                        }
                    }
                    $('<input required data-text-field="DSElementName" data-value-field="DSElementControl" data-bind="value:' + options.field + '"/>')
                        .appendTo(container)
                        .kendoDropDownList({
                            dataTextField: "DSElementName",
                            dataValueField: "DSElementControl",
                            autoBind: true,
                            dataSource: VeryNewDS,
                            change: function (e) {
                                var fee = this.dataItem(e.item);
                                options.model.set("DSElementControl", fee.ListTypeControl);
                                options.model.set("DSElementName", fee.ListTypeName);
                            }
                        });
                }
                else
                {
                    ...
                    var VeryNewDS =[{DSElementControl:'0',DSElementName:'None'}];
                    for(var i=0; i<newDS.length;i++){
                        if(newDS[i].DSElementControl == options.model.DSAttrDSElementControl){
            ...
            var l = "<h3 style='margin:10px'>"+EDITName+"- "+TPDocInOutbound+" Document Configuration </h3><h2 style='margin:10px;'>Company: "+CompName+" &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Carrier: "+CarrierName+"</h3>";
            ...
            dsDocTypeDropDownnew.read();
              //datasource for Data Map Field Table and Column
            ...
            dsSegmentElementDropDown = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "api/EDIDocStructElement/GetRecords",
                        contentType: 'application/json; charset=utf-8',
                        dataType: "json",
                        data: { filter: JSON.stringify({"filterName":"None","filterValue":"","page":1,"skip":0,"take":100}) },                    
                        headers: { "Authorization": localStorage.NGLvar1454, "USC": localStorage.NGLvar1452 }                      
                ...
                schema: {
                    ...
                    model: {
                        id: "DSElementControl",
                        fields: {
                            DSElementName: { type: "string" },
                            DSElementDesc: { type: "string" },
                            DSElementEDIDataTypeControl: { type: "number" },
                            DSElementUsage: { type: "string" },
                            DSElementMinCount: { type: "number" },
                            DSElementMaxCount: { type: "number" },
                        }
                    },
            ...
            EDIMasterDoc = new kendo.data.TreeListDataSource({
                ...
                transport: { 
                    read: function(options) { 
                        ...
                        s.filterName = "DSLoopTPDocControl";
                        s.filterValue = TPDocControl;
                        ...
                        $.ajax({ 
                            url: '/api/EDIDocStructLoop/GetRecordbyTpDoc/', 
                            contentType: 'application/json; charset=utf-8', 
                            dataType: 'json', 
                            data: { TPDocControl: TPDocControl }, 
                            headers: { "Authorization": localStorage.NGLvar1454, "USC": localStorage.NGLvar1452 }, 
                            success: function(data) {
                                ...
                                try {                                    
                                    ...
                                    if (typeof (data) !== 'undefined' && ngl.isObject(data)) {
                                        if (typeof (data.Errors) !== 'undefined' && data.Errors != null && data.Errors.length > 0) {
                                            blnErrorShown = true;
                                            //ngl.showErrMsg("Get EDI Doc Failure", data.Errors, null);
                                        }
                                        else {
                                            if (typeof (data.Data) !== 'undefined' && ngl.isArray(data.Data)) {
                                                if (data.Data.length > 0 && typeof (data.Data[0]) !== 'undefined' && ngl.isObject(data.Data[0])) {
                                    ...
                                    if (blnSuccess === false && blnErrorShown === false) {
                                        if (strValidationMsg.length < 1) { strValidationMsg = "Get EDI Doc Failure"; }
                                        ngl.showErrMsg("Get EDI Doc Failure", strValidationMsg, null);
                                    }
                                } catch (err) {
                                    ngl.showErrMsg(err.name, err.description, null);
                                }
                            ...
                            error: function (xhr, textStatus, error) {
                                ...
                                ngl.showErrMsg("Get EDI Doc Failure", sMsg, null); 
                    ...
                    destroy: function(options) {
                        ...
                        if(deteteLoop == true){
                            $.ajax({
                                url: 'api/EDIDocStructLoop/DeleteParentLoopRecord', 
                                type: 'DELETE',
                                contentType: 'application/json; charset=utf-8', 
                                dataType: 'json', 
                                data: JSON.stringify(options.data),
                                ...
                                error: function (xhr, textStatus, error) {
                                    var sMsg = formatAjaxJSONResponsMsgs(xhr, textStatus, error, "delete EDITP DocStructLoop Failure");
                                    ngl.showErrMsg("delete EDITP DocStructLoop Failure", sMsg, null); 
                                } 
                            });
                        }else{
                            refreshLoopsTreeList();
                ...
                schema: {
                    ...
                    total: "Count",
                    model: {
                        id: "DSLoopLoopControl",
                        parentId: "DSLoopParentLoopID",
                        fields: {
                            DSLoopLoopControl: { field: "DSLoopLoopControl", type: "number" },
                            DSLoopParentLoopID: { field: "DSLoopParentLoopID", type: "number" },
                            DSLoopSeqIndex: { field: "DSLoopSeqIndex", type: "number" }
                        },
                        expanded: true
                    },
                    errors: "Errors"
                ...
                sort: [
                    { field: "DSLoopSeqIndex", dir: "asc"}
                ],
                error: function(xhr, textStatus, error) {
                    ngl.showErrMsg("Access EDITP DocStructLoop Data Failed", formatAjaxJSONResponsMsgs(xhr, textStatus, error, " cannot complete your request"), null); this.cancelChanges();
                }
            });
            ...
            $("#LoopsTreeGrid").kendoTreeList({
                ...
                editable:true,
                columns: [
                       { field: "DSLoopControl", title: "DSLoopControl ", hidden: true },
                       { field: "DSLoopLoopControl", title: "Loop", width:300, hidden: false, template:data=>LoopsData._data[Object.values(LoopsData._data).findIndex(x=> x.LoopControl == data.DSLoopLoopControl)].LoopName},
                       { field: "DSLoopUsage", title: "Usage", width:200, hidden: false, template:data=>ddlUsage[Object.values(ddlUsage).findIndex(x=> x.UsControl == data.DSLoopUsage)].UsName},
                       { field: "DSLoopMinCount", title: "Minimum Count", width:100, hidden: false},
                       { field: "DSLoopMaxCount", title: "Maximum Count", width:100, hidden: false},
                       { command: [{ name: "Edit Loop", text:" ",imageClass: "k-i-edit", click: openMasterDocEditWindow},{ name: "Add Segment", text:" ",imageClass: "k-i-hyperlink", click: openMasterDocStructLoopEditWindow},{name: "destroy", text: " ",imageClass: "k-i-delete" }], title: "Action", width: "100px" },
                ]
            });
            dsDataTypeDropDown.read()
            ...
            $("#SegElementsGrid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "DSElementMinCount", title: "MinLength", hidden: false },
                    { field: "DSElementMaxCount", title: "MaxLength", hidden: false },
                    { command: [{ name: "edit", text:{edit: "", update: "", cancel: ""}},{ name: "destroy", text:"",   imageClass: "k-i-delete", iconClass: "k-icon"}], title: "Action", width: "80px" }
                ]
            });
