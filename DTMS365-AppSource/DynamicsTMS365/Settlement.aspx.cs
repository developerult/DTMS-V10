...
{
    public partial class Settlement : NGLWebUIBaseClass
    {
        
        public string  EditAccessorialsMessage { get; set; }
        public string ReadOnlyAccessorialsMessage { get; set; }

        public string sShowOrderNbrOnQuickEdit { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                refreshUserControl();
                //GlobalShowOrderNbrOnQuickEdit
                double dShowOrderNbrOnQuickEdit = Utilities.GetParValueByLegalEntity("GlobalShowOrderNbrOnQuickEdit", 0);
                if (dShowOrderNbrOnQuickEdit == 1)
                {
                    this.sShowOrderNbrOnQuickEdit = "true";
                }else
                {
                    this.sShowOrderNbrOnQuickEdit = "false";
                }
