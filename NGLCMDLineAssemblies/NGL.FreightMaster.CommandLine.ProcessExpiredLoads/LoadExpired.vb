...
Public Class LoadExpired
    ...
    Public Shared Sub Main()
        Dim sSource As String = "NGL.FreightMaster.CommandLine.ProcessExpiredLoads"
        ...
        Try
            ...
            With oApp
                .Source = sSource
                If .readCommandLineArgs("NGL.FreightMaster.CommandLine.ProcessExpiredLoads") = 0 Then
                    Exit Sub
                End If
    ...
    '        strHelpMsg = vbCrLf _
    '            & "Usage:" & vbCrLf _
    '            & " NGL.FreightMaster.CommandLine.ProcessExpiredLoads.exe [/?] " _
    '            & " [-k:inikey] -d "
