...
'
Namespace SqlReportingServices
    ...
    Partial Public Class ReportExecutionService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.NGL.FM.CMDLine.MailServer.My.MySettings.Default.NGL_FM_CMDLine_MailServer_SqlReportingServices_ReportExecutionService
