...
Public Class HotLoad
    ...
    Public Shared Sub Main()
        Dim sSource As String = "NGL.FreightMaster.CommandLine.HotLoadEmail"
        Dim oApp As New clsApplication

        EvtLog.Log = "Application"
        EvtLog.Source = sSource
        Try
            Dim strCreateUser As String = "Hot Load Email"
            Dim strCreatedDate As String = Now.ToString
            Dim intRetValue As Integer = 0
            With oApp
                .Source = sSource
                If .readCommandLineArgs("NGL.FreightMaster.CommandLine.HotLoadEmail") = 0 Then
                    Exit Sub
                End If
