...
Public Class UpdateAuthNbr
    ...
    Public Shared Sub Main()
        ...
        Try
            ...
            Dim strCreateUser As String = "System Update Auth Nbr"
            Dim strCreatedDate As String = Now.ToString
            Dim intRetValue As Integer = 0
            With oApp
                .Source = sSource
                If .readCommandLineArgs("NGL.FM.CMDLine.UpdateAuthNbr") = 0 Then
                    Exit Sub
                End If
