...
Public Class Web365Migration
    ...
    Public Shared Sub Main()
        Dim sSource As String = "NGL.FM.CMDLine.Web365Migration"
        ...
        Try
            Dim strCreateUser As String = "System Web 365 Migration"
            Dim strCreatedDate As String = Now.ToString
            Dim intRetValue As Integer = 0
            With oApp
                .Source = sSource
                If .readCommandLineArgs("NGL.FM.CMDLine.Web365Migration") = 0 Then
                    Exit Sub
                End If
