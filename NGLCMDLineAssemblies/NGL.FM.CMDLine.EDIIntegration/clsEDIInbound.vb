...
Public Class clsEDIInbound : Inherits EDIFileCore
    ...
    Public Overrides Function Save(Optional ByVal strErrMsg As String = "") As Boolean
        ...
        If String.IsNullOrEmpty(FileData) OrElse FileData.Trim.Length < 1 Then
            Dim strRetMsg = strErrMsg & " failed.  Cannot read the data from the file " & FileName & ". "
        ...
        With oEDIInput
            ...
            enumResults = .ProcessData(FileData, Me.ConnectionString)
