...
Public Class ProcessDistanceQueue
    ...
    Public Shared Sub Main()
        ...
        Try
            ...
            Dim strCreateUser As String = "System Process Distance Queue"
            Dim strCreatedDate As String = Now.ToString
            Dim intRetValue As Integer = 0
            With oApp
                .Source = sSource
                If .readCommandLineArgs("NGL.FM.CMDLine.ProcessDistanceQueue") = 0 Then
                    Exit Sub
                End If
