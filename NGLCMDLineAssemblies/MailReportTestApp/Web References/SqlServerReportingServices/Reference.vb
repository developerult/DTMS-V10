...
'
Namespace SqlServerReportingServices
    ...
    Partial Public Class ReportExecutionService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.MailReportTestApp.My.MySettings.Default.MailReportTestApp_SqlServerReportingServices_ReportExecutionService
