...
Public Class Archive
    ...
    Public Shared Sub Main()
        Dim sSource As String = "NGL.FreightMaster.CommandLine.Archive"
        Dim oApp As New clsApplication

        EvtLog.Log = "Application"
        EvtLog.Source = sSource
        Try
            Dim strCreateUser As String = "System Archive"
            Dim strCreatedDate As String = Now.ToString
            Dim intRetValue As Integer = 0
            With oApp
                .Source = sSource
                'If .readParameters("NGL.FreightMaster.CommandLine.Archive") = 0 Then
                '    Exit Sub
                'End If
                If .readCommandLineArgs("NGL.FreightMaster.CommandLine.Archive") = 0 Then
                    Exit Sub
                End If
