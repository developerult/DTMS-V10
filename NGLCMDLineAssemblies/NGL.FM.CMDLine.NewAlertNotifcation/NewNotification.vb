...
Public Class NewNotification
    ...
    Public Shared Sub Main()
        Dim sSource As String = "NGL.FreightMaster.CommandLine.NewNotification"
        ...
        Try
            ...
            With oApp
                .Source = sSource
                If .readCommandLineArgs("NGL.FreightMaster.CommandLine.NewNotification") = 0 Then
                    Exit Sub
                End If
                ...
                Debug = .Debug
                'If .readParameters("NGL.FreightMaster.CommandLine.NewNotification") = 0 Then
                '    Exit Sub
                'End If
