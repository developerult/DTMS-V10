...
Namespace Model
    ...
    Public Class UserSecurity : Inherits Ngl.Core.DirectDataObject

#Region "Class Variables and Properties"

        Private _oUserSecurityTable As SystemSecurityData.tblUserSecurityDataTable = Nothing
        Public ReadOnly Property oUserSecurityTable() As SystemSecurityData.tblUserSecurityDataTable
            Get
                If _oUserSecurityTable Is Nothing Then
                    _oUserSecurityTable = Me.GetData
                End If
                Return _oUserSecurityTable
            End Get
        End Property
        ...
        Private _strName As String = "Users"
        ...
        Private _Adapter As tblUserSecurityTableAdapter
        Protected ReadOnly Property Adapter() As tblUserSecurityTableAdapter
            Get
                If _Adapter Is Nothing Then
                    _Adapter = New tblUserSecurityTableAdapter
...
#Region "Functions"
        ...
        Public Function GetData() As SystemSecurityData.tblUserSecurityDataTable
            Adapter.SetCommandTimeOut(Me.CommandTimeOut)
            Return (Adapter.GetData())
        End Function

        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
        Public Function GetDataByID(ByVal ID As Integer) As SystemSecurityData.tblUserSecurityDataTable
            Adapter.SetCommandTimeOut(Me.CommandTimeOut)
            Return (Adapter.GetDataByID(ID))
        End Function

        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
        Public Function GetDataByName(ByVal Name As String) As SystemSecurityData.tblUserSecurityDataTable
            Adapter.SetCommandTimeOut(Me.CommandTimeOut)
            Return (Adapter.GetDataByName(Name))
        End Function

        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
        Public Function GetDataByNameNotSelected(ByVal Name As String, ByVal ID As Integer) As SystemSecurityData.tblUserSecurityDataTable
            Adapter.SetCommandTimeOut(Me.CommandTimeOut)
            Return (Adapter.GetDataByNameNotSelected(Name, ID))
        End Function

        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
        Public Function GetList() As SystemSecurityData.tblUserSecurityDataTable
            Adapter.SetCommandTimeOut(Me.CommandTimeOut)
