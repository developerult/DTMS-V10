...
#Region " Data Members"
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Private _Items As New List(Of NEXTrackTreeNode)
        <DataMember()> _
        Public Property Items() As List(Of NEXTrackTreeNode)
            Get
                Return _Items
            End Get
            Set(ByVal value As List(Of NEXTrackTreeNode))
                _Items = value
...
#Region " Public Methods"
        Public Overrides Function Clone() As DTOBaseClass
            Dim instance As New NEXTrackTreeNode
            instance = DirectCast(MemberwiseClone(), NEXTrackTreeNode)
            instance.Items = Nothing
            If Not Items Is Nothing Then
                For Each item In Items
                    instance.Items.Add(DirectCast(item.Clone, NEXTrackTreeNode))
                Next
            End If
            Return instance
        End Function
