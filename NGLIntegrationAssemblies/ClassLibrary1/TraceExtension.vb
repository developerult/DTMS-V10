...
Public Class TraceExtension
    ...
    Public Overloads Overrides Function GetInitializer(ByVal WebServiceType As _
      Type) As Object
        ...
        ' type.
        Return "C:\Data\TMSLogs\" + WebServiceType.FullName + ".log"
    End Function
    ...
    Public Sub WriteOutput(ByVal message As SoapMessage)
        ...
        Dim fs As New FileStream(m_filename, FileMode.Append,
                                 FileAccess.Write)
...
End Class
    ...
    Private m_filename As String = "c:\Data\TMSLogs\Tracelog.txt"
