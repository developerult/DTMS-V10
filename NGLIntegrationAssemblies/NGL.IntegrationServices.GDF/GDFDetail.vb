...
Public Class GDFDetails
                ...
                For Each r As String In strDetails
                    Try
                        ...
                        If strRow.Length >= 8 Then
                            ...
                            Items.Add(D)
                        Else
                            Errors &= "GDFDetail.ReadFromString Error; invalid row not enough columns:" & vbCrLf & "     " & r & vbCrLf & vbCrLf
                        End If
                    Catch ex As ApplicationException
                        Errors &= "GDFDetail.ReadFromString parse CSV Error: " & ex.Message & vbCrLf & vbCrLf
                    End Try
                Next
            End If
        Catch ex As Exception
            Errors &= "GDFDetail.ReadFromString Unexpected Error: " & ex.Message & vbCrLf & vbCrLf
    ...
    Public Function ReadFromFile(ByVal fileName As String, Optional ByVal Details As List(Of Object) = Nothing) As List(Of Object) Implements IDetails.ReadFromFile
                ...
                For Each r In DRecords
                    Try
                        ...
                        If strRow.Length >= 8 Then
                            ...
                            Items.Add(D)
                        Else
                            Errors &= "GDFDetail.ReadFromFile Error; invalid row not enough columns:" & vbCrLf & "     " & r & vbCrLf & vbCrLf
                        End If
                    Catch ex As ApplicationException
                        Errors &= "GDFDetail.ReadFromFile parse CSV Error: " & ex.Message & vbCrLf & vbCrLf
                    End Try
                Next
            Else
                Errors &= errMsg
        ...
        Catch ex As Exception
            Errors &= "GDFDetail.ReadFromFile Unexpected Error: " & ex.Message & vbCrLf & vbCrLf
        End Try
        Return Items
