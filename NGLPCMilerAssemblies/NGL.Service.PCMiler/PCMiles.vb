...
<Assembly: ApplicationName("NGL.Service.PCMiler")> 
<Assembly: ApplicationActivation(ActivationOption.Server)> 
<Assembly: AssemblyKeyFile("../../NGL.Service.PCMiler.snk")> 
<Assembly: ApplicationAccessControl()> 

<Guid("947A6E00-B406-4d36-B607-7566820D32A5"), _
...
#Region "Methods"
    ...
    Function getPracticalMiles(ByVal objOrig As clsAddress, _
                            ...
                            ByVal Route_Type As INGL_Service_PCMiler.PCMEX_Route_Type, _
                            ByVal Dist_Type As INGL_Service_PCMiler.PCMEX_Dist_Type, _
...
#Region "New Methods for v-5.1.4"
    ...
    Function PCMReSyncMultiStop(ByRef arrFMStops As clsFMStopData(), _
                       ByVal dblBatchID As Double, _
                       ByVal blnKeepStopNumbers As Boolean, _
...
<Guid("45D79A7F-749C-498b-9EF2-9322F4813173"),
ClassInterface(ClassInterfaceType.None),
ProgId("NGL.Service.PCMiler"),
...
#Region "New Methods for v-5.1.4"
    ...
    ''' loads
    '''  </remarks>
    Public Function PCMReSyncMultiStop(ByRef arrFMStops As clsFMStopData(), _
                        ByVal dblBatchID As Double, _
                        ByVal blnKeepStopNumbers As Boolean, _
        ...
        Dim oGlobalStopData = PCMReSyncMultiStop(oFMStops, _
                        dblBatchID, _
    ...
    ''' loads
    '''  </remarks>
    Private Function PCMReSyncMultiStop(ByRef oFMStops As List(Of clsFMStopData), _
                        ByVal dblBatchID As Double, _
                        ByVal blnKeepStopNumbers As Boolean, _
