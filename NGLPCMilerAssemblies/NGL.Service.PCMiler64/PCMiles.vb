...
<Assembly: ApplicationName("NGL.Service.PCMiler64")> 
<Assembly: ApplicationActivation(ActivationOption.Server)> 
<Assembly: AssemblyKeyFile("../../NGL.Service.PCMiler64.snk")> 
<Assembly: ApplicationAccessControl()> 

<Guid("1DB71779-F0E8-4143-BE3A-689388842839"), _
InterfaceType(ComInterfaceType.InterfaceIsDual)> _
Public Interface INGL_Service_PCMiler

#Region "Enums"
    ''' <summary>
    ''' Reference to Route Type used for standard PCMSSetCalcType
    ''' It also maps to the PCMilerRouteType global parameter in TMS
    ''' Backward compatibility allows all 6 options, however,
    ''' values of 0,1, and 4 will automatically map to 
    ''' CALCTYPE_PRACTICAL,CALCTYPE_SHORTEST, and CALCTYPE_AIR respectively
    ''' </summary>
...
#Region "Methods"
    ...
    Sub openLog()
    Sub closeLog(Optional ByVal intReturn As Integer = 0)
    Function CityToLatLong(ByRef cityZip As String) As String
    Function cityStateZipLookup(ByVal zip As String) As clsAddress()
    Function FullName(ByVal CityNameOrZipCode As String) As String
    Function getGeoCode(ByVal location As String, ByRef dblLat As Double, ByRef dblLong As Double) As Boolean
    Function LatLongToCity(ByVal latlong As String) As String
    ...
    ''' <summary>
    ''' Overload extended calculation options like shortest -- 53Foot route
    ''' </summary>
    ...
    Function Miles(ByVal Origin As String, ByVal Destination As String) As Single
    Function PCMilerEnd() As Short
    Function PCMilerStart() As Short
    Function Server() As Short
    Function zipcode(ByVal CityName As String) As String
    Function PCMReSync(ByVal arrStopData() As clsPCMDataStop, _
    ...
    Function getRouteMiles(ByRef sRoute As clsSimpleStop()) As clsPCMReturn
...
#Region "New Methods for v-5.1.4"
    ...
    Function PCMReSyncMultiStop(ByRef arrFMStops As clsFMStopData(),
                       ByVal dblBatchID As Double,
    ...
    '''   with extended calculation options like shortest 53Foot routing
    ''' </remarks>
    Function PCMReSyncMultiStopEx(ByRef arrFMStops As clsFMStopData(),
                                  ByVal EXCALC_Type As INGL_Service_PCMiler.PCMEX_CALCTYPE,
                                  ByVal EXOpt_Flags As INGL_Service_PCMiler.PCMEX_Opt_Flags,
                                  ByVal EXVeh_Type As INGL_Service_PCMiler.PCMEX_Veh_Type,
                                  ByVal dblBatchID As Double,
...
'ConstructionEnabled([Default]:="Data Source=NGLSQL01t;Initial Catalog=NGLMAS2002Test;Integrated Security=True"), _

<Guid("662E8C02-1F77-4DFF-B3A5-DD586AB712AD"),
ClassInterface(ClassInterfaceType.None),
ProgId("NGL.Service.PCMiler64"),
ConstructionEnabled([Default]:="Data Source=SAGARPC;Initial Catalog=NGLTMSPROD;Integrated Security=True"),
Transaction(TransactionOption.Supported),
JustInTimeActivation(True), Serializable(),
ObjectPooling(MinPoolSize:=2, MaxPoolSize:=5, CreationTimeout:=20000),
ComponentAccessControl(), SecurityRole("Administrator"), SecurityRole("User", SetEveryoneAccess:=True)>
Public Class PCMiles
    Inherits ServicedComponent
    Implements INGL_Service_PCMiler
#Region "Overrides"
...
#Region "Properties"
    ...
    Public ReadOnly Property ConnectionString() As String Implements INGL_Service_PCMiler.ConnectionString
        Get
    ...
    Public ReadOnly Property ServerID() As Short Implements INGL_Service_PCMiler.ServerID
        Get
            Return gServerID
        End Get
    End Property
    ...
    Public Property Debug() As Boolean Implements INGL_Service_PCMiler.Debug
        Get
            Debug = _blnDebug
        End Get
    ...
    Public ReadOnly Property LastError() As String Implements INGL_Service_PCMiler.LastError
        Get
    ...
    Public Property LoggingOn() As Boolean Implements INGL_Service_PCMiler.LoggingOn
        Get
    ...
    Public Property LogFileName() As String Implements INGL_Service_PCMiler.LogFileName
        Get
    ...
    Public Property KeepLogDays() As Integer Implements INGL_Service_PCMiler.KeepLogDays
        Get
    ...
    Public Property SaveOldLog() As Boolean Implements INGL_Service_PCMiler.SaveOldLog
        Get
    ...
    Public Property UseZipOnly() As Boolean Implements INGL_Service_PCMiler.UseZipOnly
        Get
    ...
    Public Property PCMBuffers() As String() Implements INGL_Service_PCMiler.PCMBuffers
        Get
            Return _PCMBuffers
        End Get
        Set(ByVal value As String())
...
#Region "Methods"
    ...
    <AutoComplete()> _
    Public Function About() As String Implements INGL_Service_PCMiler.About
    ...
    Public Sub openLog() Implements INGL_Service_PCMiler.openLog
    ...
    Public Sub closeLog(Optional ByVal intReturn As Integer = 0) Implements INGL_Service_PCMiler.closeLog
    ...
    End Function
    <AutoComplete()> _
    Public Function CityToLatLong(ByRef cityZip As String) As String Implements INGL_Service_PCMiler.CityToLatLong
    ...
    <AutoComplete()> _
    Public Function cityStateZipLookup(ByVal zip As String) As clsAddress() Implements INGL_Service_PCMiler.cityStateZipLookup
    ...
    <AutoComplete()> _
    Public Function FullName(ByVal CityNameOrZipCode As String) As String Implements INGL_Service_PCMiler.FullName
    ...
    <AutoComplete()> _
    Public Function getGeoCode(ByVal location As String, ByRef dblLat As Double, ByRef dblLong As Double) As Boolean Implements INGL_Service_PCMiler.getGeoCode
    ...
    <AutoComplete()> _
    Public Function LatLongToCity(ByVal latlong As String) As String Implements INGL_Service_PCMiler.LatLongToCity
        Dim buffer As StringBuilder = New StringBuilder(100)
        Dim Ret As Short = 0
    ...
    Function getPracticalMiles(ByVal objOrig As clsAddress,
                            ...
                            ByVal dblBatchID As Double,
                            ByVal blnBatch As Boolean,
                            ByRef arrBaddAddresses() As clsPCMBadAddress) As clsGlobalStopData Implements INGL_Service_PCMiler.getPracticalMiles
    ...
    Function getPracticalMilesEx(ByVal objOrig As clsAddress,
                            ...
                            ByVal dblBatchID As Double,
                            ByVal blnBatch As Boolean,
                            ByRef arrBaddAddresses() As clsPCMBadAddress) As clsGlobalStopData Implements INGL_Service_PCMiler.getPracticalMilesEx
    ...
    <AutoComplete()> _
    Public Function Miles(ByVal Origin As String, ByVal Destination As String) As Single Implements INGL_Service_PCMiler.Miles
        Dim mi As Integer = 0
        Dim oo As String = ""
        Dim dd As String = ""
    ...
    Public Function PCMilerEnd() As Short Implements INGL_Service_PCMiler.PCMilerEnd
    ...
    Public Function PCMilerStart() As Short Implements INGL_Service_PCMiler.PCMilerStart
    ...
    Public Function Server() As Short Implements INGL_Service_PCMiler.Server
        Server = gServerID
    End Function

    <AutoComplete()> _
    Public Function zipcode(ByVal CityName As String) As String Implements INGL_Service_PCMiler.zipcode
        Dim strRet As String = ""
    ...
    Public Function PCMReSync(ByVal arrStopData() As clsPCMDataStop, _
                        ...
                        ByVal blnKeepStopNumbers As Boolean, _
                        ByRef arrAllStops() As clsAllStop, _
                        ByRef arrBaddAddresses() As clsPCMBadAddress) As clsGlobalStopData Implements INGL_Service_PCMiler.PCMReSync
        Dim Ret As Integer = 0
        Dim i As Integer = 0
    ...
    End Function
    <AutoComplete()> _
    Public Function getRouteMiles(ByRef sRoute As clsSimpleStop()) As clsPCMReturn Implements INGL_Service_PCMiler.getRouteMiles
...
#Region "New Methods for v-5.1.4"
    ...
    '''   added logic to check trip id and retry 3 times if possible.
    ''' </remarks>
    Public Function PCMValidateAddress(ByVal strAddress As String) As Boolean Implements INGL_Service_PCMiler.PCMValidateAddress
        Dim intTrip1 As Integer = 0
        _strLastError = ""
        Dim blnRet As Boolean = False
        Try
    ...
    Public Function PCMReSyncMultiStop(ByRef arrFMStops As clsFMStopData(),
                        ByVal dblBatchID As Double,
                        ByVal blnKeepStopNumbers As Boolean,
                        ByRef arrPCMReportRecords As clsPCMReportRecord()) As clsGlobalStopData Implements INGL_Service_PCMiler.PCMReSyncMultiStop
    ...
    Public Function PCMReSyncMultiStopEx(ByRef arrFMStops As clsFMStopData(),
                                         ...
                                         ByVal dblBatchID As Double,
                                         ByVal blnKeepStopNumbers As Boolean,
                                         ByRef arrPCMReportRecords As clsPCMReportRecord()) As clsGlobalStopData Implements INGL_Service_PCMiler.PCMReSyncMultiStopEx
    ...
    ''' </remarks>
    Private Function buildTrip(ByVal oFMStops As List(Of clsFMStopData), _
                               ByRef oPCMReportRecords As List(Of clsPCMReportRecord), _
                               ByRef oGlobalStopData As clsGlobalStopData, _
                               ByVal intTrip1 As Integer, _
                               ByVal blnKeepStopNumbers As Boolean, _
