...
#Region "New Methods for v-5.1.4"
    ...
    ''' loads
    ''' Modified by RHR v-7.0.5.100 05/25/2016
    '''   added additional logic to always optimize miles when blnKeepStopNumbers is false
    '''   the new logic always loads the origin first but then tries 
    '''   multiple pickup locations as first stop to optimize miles
    '''  </remarks>
    ...
    ''' <remarks>
    ''' Created by RHR v-7.0.5.100 05/25/2016
    '''  created method stub to encapsulate logic for easier  
