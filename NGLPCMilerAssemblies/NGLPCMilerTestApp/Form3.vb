...
Public Class Form3
    ...
    Private _OrderList As New List(Of clsAddress)
    Public Property OrderList() As List(Of clsAddress)
        Get
            If _OrderList Is Nothing Then _OrderList = New List(Of clsAddress)
            Return _OrderList
        End Get
        Set(ByVal value As List(Of clsAddress))
            _OrderList = value
        End Set
    End Property
    ...
    Private Sub SetupOrderList()
        'add order 1
        Me.OrderList = New List(Of clsAddress)

        Dim oAddress As New clsAddress() With {.strAddress = "127 Bo's Way", _
                                               .strCity = "Deer Lodge", _
                                               .strState = "TN", _
                                               .strZip = "37726"}
        Me.OrderList.Add(oAddress)
        oAddress = New clsAddress() With {.strAddress = "1611 Colonial Parkway", _
                                               .strCity = "Inverness", _
                                               .strState = "IL", _
                                               .strZip = "60067"}
        Me.OrderList.Add(oAddress)
        Me.txtOrder1.Text = "PRO12345 " & vbCrLf & "From: 127 Bo's Way " & vbCrLf & "Deer Lodge, TN 37726" _
            & vbCrLf & "To: 1611 Colonial Parkway " & vbCrLf & "Inverness, IL 60067"
        ...
        oAddress = New clsAddress() With {.strAddress = "5404 Wisconsin Ave", _
                                              .strCity = "Chevy Chase", _
                                              .strState = "MD", _
                                              .strZip = "52081"}
        Me.OrderList.Add(oAddress)
        Me.txtOrder2.Text = "PRO12346 " & vbCrLf & "From: 1611 Colonial Parkway " & vbCrLf & "Inverness, IL 60067" _
            & vbCrLf & "To: 5404 Wisconsin Ave " & vbCrLf & "Chevy Chase, MD 52081"
        ...
        oAddress = New clsAddress() With {.strAddress = "211 W Farms Mall", _
                                              .strCity = "Farmington", _
                                              .strState = "CT", _
                                              .strZip = "06032"}
        Me.OrderList.Add(oAddress)
        Me.txtOrder3.Text = "PRO12347 " & vbCrLf & "From: 1611 Colonial Parkway " & vbCrLf & "Inverness, IL 60067" _
            & vbCrLf & "To: 211 W Farms Mall " & vbCrLf & "Farmington, CT 06032"
        ...
        oAddress = New clsAddress() With {.strAddress = "723 North Hampton Drive", _
                                              .strCity = "New York", _
                                              .strState = "NY", _
                                              .strZip = "11010"}
        Me.OrderList.Add(oAddress)
        Me.txtOrder4.Text = "PRO12348 " & vbCrLf & "From: 1611 Colonial Parkway " & vbCrLf & "Inverness, IL 60067" _
            & vbCrLf & "To: 723 North Hampton Drive " & vbCrLf & "New York,  NY 11010"
    ...
    Private Sub clearSolution()
        ...
        Me.dgvCarriers.DataSource = Nothing
        Me.dgvCarriers.Refresh()
    ...
    Private Sub ShowCarriers()
        Dim oCarriers As New List(Of clsCarrier)
        oCarriers.Add(New clsCarrier("YRC", "$2,000", "$500"))
        oCarriers.Add(New clsCarrier("Conway", "$3,000", "$600"))
        oCarriers.Add(New clsCarrier("Budreck", "$4,000", "$500"))

        Me.dgvCarriers.DataSource = Nothing
        Me.dgvCarriers.DataSource = oCarriers
        Me.dgvCarriers.Refresh()
    End Sub
    ...
    Private Sub btnCATest_Click(sender As Object, e As EventArgs)
        Me.Cursor = Cursors.WaitCursor
    ...
    Private Sub btnCA2PickTest_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnCAKeepStopTest_Click(sender As Object, e As EventArgs)
    ...
    Private Sub txtOrder1_DoubleClick(sender As Object, e As EventArgs) Handles txtOrder1.DoubleClick
    ...
    Private Sub txtOrder2_DoubleClick(sender As Object, e As EventArgs) Handles txtOrder2.DoubleClick
    ...
    Private Sub txtOrder3_DoubleClick(sender As Object, e As EventArgs) Handles txtOrder3.DoubleClick
        addStop(OrderList(4))
        addStop(OrderList(5))
    End Sub

    Private Sub txtOrder4_DoubleClick(sender As Object, e As EventArgs) Handles txtOrder4.DoubleClick
        addStop(OrderList(6))
        addStop(OrderList(7))
    End Sub
