...
namespace PCMDLLTONET
{
    public class PCM
    {
        ...
        //Error functions
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSGetError", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern int PCMSGetError();

        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSGetErrorString", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        ...
        // Complex functions
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSSetMiles", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern short PCMSSetMiles(int tripID);
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSCityToLatLong", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern short PCMSCityToLatLong(short serverID, string cityZip, StringBuilder buffer, short bufLen);
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSLatLongToCity", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern short PCMSLatLongToCity(short serverID, String latlong, StringBuilder buffer, short bufLen);
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSSetKilometers", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        ...
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSSetResequence", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        ...
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSGetRpt", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern int PCMSGetRpt(int tripID, int rptNum, StringBuilder buffer, int bufLen);
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSGetRptLine", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern int PCMSGetRptLine(int tripID, int rptNum, int lineNum, StringBuilder buffer, int bufLen);
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSNumRptLines", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern int PCMSNumRptLines(int tripID, int rptNum);

        // Trip options

        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSOptimize", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        ...
        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSClearStops", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern short PCMSClearStops(int tripID);

        [System.Runtime.InteropServices.DllImport("PCMSRV32.DLL", EntryPoint = "PCMSSetCalcType", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
