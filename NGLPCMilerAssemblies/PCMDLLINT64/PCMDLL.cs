...
namespace PCMDLLINT64
{
    public class PCM
    {
        ...
        [System.Runtime.InteropServices.DllImport("PCMSRV64.DLL", EntryPoint = "PCMSNumLegs", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
        public static extern int PCMSNumLegs(int tripID);

        [System.Runtime.InteropServices.DllImport("PCMSRV64.DLL", EntryPoint = "PCMSGetLegInfo", ExactSpelling = false, CharSet = System.Runtime.InteropServices.CharSet.Ansi, SetLastError = true)]
